                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    @foreach ($applicationServices as $item)
                                                                        <tr>
                                                                            <td
                                                                                class="align-middle pl-0 border-0 font-size-h6 text-info font-weight-boldest">
                                                                            ...
                                                                            <td
                                                                                class="align-middle pl-0 border-0 font-size-h6 text-primary font-weight-bolder">
                                                                            ...
                                                                            <td
                                                                                ...
                                                                                @if ($application->user->country_id == 19)
                                                                                    @if ($item->service_id == 2)
                                                                                        {{ number_format((float) $item->service_inventory_item_price, 2, '.', '') }}
                                                                                        BDT
                                                                                    @else
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-right d-flex flex-column">
                                                                ...
                                                                <span
                                                                    ...
                                                                    @if ($application->user->country_id == 19)
                                                                        {{ number_format((float) $application->total_price, 2, '.', '') }}
                                                                        {{ $item->service_id == 2 ? "BDT" : "USD"}} 
                                                                    @else
                                                                        {{ number_format((float) $application->total_price, 2, '.', '') }}
                                                                        {{ $item->service_id == 2 ? "BDT" : "USD"}} 
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-right d-flex flex-column">
                                                                ...
                                                                <span
                                                                    ...
                                                                    @if ($application->user->country_id == 19)
                                                                        {{ $application->discount != '' ? number_format((float) $application->discount, 2, '.', '') : 0.0 }}
                                                                        {{ $item->service_id == 2 ? "BDT" : "USD"}} 
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="text-right d-flex flex-column">
                                                                ...
                                                                <span
                                                                    ...
                                                                    @if ($application->user->country_id == 19)
                                                                        {{ number_format((float) $application->final_total, 2, '.', '') }}
                                                                        {{ $item->service_id == 2 ? "BDT" : "USD"}} 
