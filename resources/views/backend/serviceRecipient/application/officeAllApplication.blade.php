                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($applications as $application)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">{{$application->application->usage_type == 1 ? 'Organization' : 'Personal'}}</td>
                                                        ...
                                                        <td>
                                                            @if ($application->application->status == 1)
                                                                <span class="label label-lg font-weight-bold label-light-info label-inline" style="font-size: 15px; padding: 17px;">লতবি</span>
