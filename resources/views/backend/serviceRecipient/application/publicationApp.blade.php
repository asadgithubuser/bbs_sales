				...
				<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						...
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							<!--begin::Page Title-->
							<h5 class="text-dark font-weight-bold my-1 mr-5">Create Publication Application</h5>
							<!--end::Page Title-->
							<!--begin::Breadcrumb-->
													...
													<td>
														<div class="alert-text text-right">
															<span class="font-weight-bold">
																...
																<span type="text" class="totalPrice" value="" readonly style="font-weight:bold;width: 100%; text-align: right;"></span> <span style="font-weight:bold;width: 100%; text-align: right;">BDT</span>
															</span>
														</div>
													</td>
												</tr>
