				...
				<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						...
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							<!--begin::Page Title-->
							<h5 class="text-dark font-weight-bold my-1 mr-5">Create Micro Data Application</h5>
							<!--end::Page Title-->
							<!--begin::Breadcrumb-->
							{{-- <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
								...
								<li class="breadcrumb-item active">
									<a class="text-muted">Create Micro Data Application</a>
								</li>
							</ul> --}}
							<!--end::Breadcrumb-->
						</div>
						...
						<div class="col-lg-12">
							...
							<div class="card card-custom example example-compact">
								<div class="card-header">
									<h3 class="card-title">Create Micro Data Application</h3>
								</div>
								...
								<form class="form appForm" id="kt_form_1" autocomplete="off" method="POST" action="javascript:void(0)">
									@csrf
									<!--Hidden data-->
									<input type="hidden" name="application_for" value="micro_data">
									...
									<div class="card-body application-card">
										...
										<div class="card card-custom example example-compact">
											<div class="form-group m-0">
												<div class="alert alert-custom alert-default" role="alert" style="padding: 0.5rem 2rem;">
													<div class="alert-text form_header"><span class="font-weight-bold">User Information</span></div>
												</div>
											</div>
											...
											<thead> 
												<tr> 
													<th style="padding: 0; border:none;">
														<div class="form-group">
															<div class="alert alert-custom alert-default" role="alert">
																<div class="alert-text form_header"><span class="font-weight-bold">Services</span></div>
															</div>
														</div>
													</th>
														...
														<div id="service__item_filter"> 
															<div class="form-group row mx-1">
																<div class="col-lg-6 col-md-6 col-sm-12 mb-3">
																	<select class="form-control select3 locate" name="service_item_type" id="service_item_type">
																...
																<div class="col-lg-6 col-md-6 col-sm-12 mb-3">
																	<select class="form-control select3 locate" name="data_subcategory_id" id="data_subcategory_id">
															...
															<div class="checkbox-list">
																@foreach ($services as $service)
																	<label class="checkbox" style="margin: 0 auto 1rem auto;">
																		<input type="checkbox" name="service_id[]" class="service_id" value="{{ $service->id }}" id="service_id{{ $service->id }}">
																		<span></span>{{ $service->name_en }}
																	</label>
																@endforeach
															</div>

															<span id="service_id_error" class=" text-danger"></span>
														</div>
													</td>
													<td style=""> 
														<div class="form-group">
										...
										<div class="card card-custom example example-compact" id="user_location" style="display: none">

											<div class="form-group">
												<div class="alert alert-custom alert-default" role="alert" style="padding: 0.5rem 2rem;">
													<div class="alert-text form_header"><span class="font-weight-bold">Your Recommended Location</span></div>
												</div>
											</div>

											<div class="form-group row">

												<label class="col-form-label text-right col-lg-2 col-sm-12 pl-0 pr-0">Select Division :<span class="text-danger">*</span></label>

												<div class="col-lg-3 col-md-4 col-sm-12">
													<select class="form-control select2" name="division_id" id="division_id2">
														<option value="">--Select Division--</option> 
														@foreach ($divisions as $division)
															<option value="{{ $division->id }}">{{ $division->name_en }}</option>
														@endforeach
													</select>
													<span id="division_id_error" class=" text-danger"></span>
												</div>

												<label class="col-form-label text-right col-lg-2 col-sm-12 pl-0 pr-0">Select District :<span class="text-danger">*</span></label>
												<div class="col-lg-3 col-md-4 col-sm-12">
													<select class="form-control select2" name="district_id" id="district_id2">
											...
											<div class="form-group row">
												...
												<label class="col-form-label text-right col-lg-2 col-sm-12 pl-0 pr-0">Select Upazila :<span class="text-danger">*</span></label>
												<div class="col-lg-3 col-md-4 col-sm-12">
													<select class="form-control select2" name="upazila_id" id="upazila_id2">
														<option value="">--Select District First--</option> 
													</select>
												</div>

												<label class="col-form-label text-right col-lg-2 col-sm-12 pl-0 pr-0">Select Union :<span class="text-danger">*</span></label>
												<div class="col-lg-3 col-md-4 col-sm-12">
													<select class="form-control select2" name="union_id" id="union_id2">
											...
											<div class="form-group row">
												...
												<label class="col-form-label text-right col-lg-2 col-sm-12 pl-0 pr-0">Select Mouza :<span class="text-danger">*</span></label>
												
												<div class="col-lg-3 col-md-4 col-sm-12">
													<select class="form-control select2" name="mouza_id" id="mouza_id2">
										...
										<div class="card card-custom example example-compact mt-8">
											...
											<div class="form-group">
												<div class="alert alert-custom alert-default" role="alert" style="padding: 0.5rem 2rem;">
													<div class="alert-text form_header"><span class="font-weight-bold">Terms & Conditions</span></div>
												</div>
											</div>
											...
											{{-- <div class="form-group row">
												...
												<div class="col-lg-8 col-md-8 col-sm-12">
													<div class="radio-inline" id="receiving_mode2">
														@php
															$receivingModes = App\Models\ReceivingMode::where('id', 3)->orWhere('id', 4)->get();
														@endphp

														@foreach ($receivingModes as $receivingMode)
															<label class="col-form-label radio"> 
																<input type="radio" name="receiving_mode_softcopy" id="receiving_mode_softcopy" class="dataChange" value="{{ $receivingMode->id }}" required>
											...
											<input type="hidden" value="4" name="receiving_mode_softcopy">
	...
	@push('stackScript')
					...
					if (result.isConfirmed) {
						$.ajax({
							...
							error: function(error){
								...
								$("#application_sub_error").text(error.responseJSON.application_sub);
		...
		<script>
    		function receiving_mode(id){
				...
				let data = $('.receiving_mode_type'+id).val();
