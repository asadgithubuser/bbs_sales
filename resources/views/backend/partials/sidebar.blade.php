    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper" style="background: #EBF9CF !important;">
        ...
        <div id="kt_aside_menu" class="aside-menu mb-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                @can('dollar_value_in_taka')
                    <!-- manage faq -->
                    <li class="menu-item menu-item-submenu {{ session('lsbm') == 'dollar_value_in_taka' ? ' menu-item-open ' : '' }}"
                        aria-haspopup="true" data-menu-toggle="hover">
                        <a href="javascript:;" class="menu-link menu-toggle">
                            <span class="svg-icon menu-icon">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
                            ...
                            <span class="menu-text">ডলারের মূল্য নির্ধারণ করুন টাকাতে</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="menu-submenu">
                            <i class="menu-arrow"></i>
                            <ul class="menu-subnav">
                                ...
                                <li class="menu-item {{ session('lsbsm') == 'dollar_convert_in_taka_list' ? ' menu-item-active ' : '' }}"
                                    aria-haspopup="true">
                                    <a href="{{ route('admin.payment.dollarValueConvertInTaka') }}" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                        <span class="menu-text">ডলারের মূল্য নির্ধারণ করুন</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                <li class="menu-item {{ session('lsbsm') == 'allModifyCourse' ? ' menu-item-active ' : '' }}"
                                    aria-haspopup="true">
                                    <a href="{{ route('admin.course.allModify') }}" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                ...
                                {{-- <li class="menu-item {{ session('lsbsm') == 'createCalender' ? ' menu-item-active ' : '' }}" aria-haspopup="true">
                                    <a href="{{ route('admin.calender.create') }}" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                        <span class="menu-text">Create Calender</span>
                                    </a>
                                </li> --}}
                            ...
                            <ul class="menu-subnav">
                                ...
                                <li class="menu-item {{ session('lsbsm') == 'approvedCalendar' ? ' menu-item-active ' : '' }}"
                                    ...
                                    <a href="{{ route('admin.calender.calender', ['type' => 'approved']) }}"
                                        ...
                                        <span class="menu-text">Approved Calender</span>
                                    </a>
                                </li>
                    ...
                    <li class="menu-item menu-item-submenu {{ session('lsbm') == 'report' ? ' menu-item-open ' : '' }}"
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                @can('online_sales_report')
                                    ...
                                    <li class="menu-item {{ session('lsbsm') == 'onlineSales' ? ' menu-item-active ' : '' }}"
                                        ...
                                        <a href="{{ route('admin.report.onlineSales') }}" class="menu-link">
                                            ...
                                            <span class="menu-text">Micro Data Sales</span>
                                        </a>
                                    </li>
                                @endcan
                                @can('online_all_download_report')
                                ...
                                @can('complementary_stock_report')
                ...
                <li class="menu-item menu-item-submenu {{ session('lsbm') == 'surveyReports' ? ' menu-item-open ' : '' }}"
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item {{ session('lsbsm') == 'surveyReportstofsile2crop1' ? 'menu-item-active' : '' }}"
                                        aria-haspopup="true">
                                        
                                        <a href="{{ route('admin.processingList.tofsilReportData2',['type'=>1]) }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">
                                                
                                                    ফসল কর্তন ও উৎপাদন জরিপ (আউস) (তফসিল-২) প্রতিবেদন 
                                                
                                            </span>
                                        </a>
                                    </li>

                                    <li class="menu-item {{ session('lsbsm') == 'surveyReportstofsile2crop5' ? 'menu-item-active' : '' }}"
                                        aria-haspopup="true">
                                        
                                        <a href="{{ route('admin.processingList.tofsilReportData2',['type'=>5]) }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">
                                                
                                                    ফসল কর্তন ও উৎপাদন জরিপ (গম) (তফসিল-২) প্রতিবেদন 
                ...
                {{-- change password --}}
                {{-- @can('edit_profile')
                    <li class="menu-item {{ session('lsbsm') == 'edit_profile' ? 'menu-item-active ' : '' }}"
                    aria-haspopup="true">
                        <a href="{{ route('admin.user.editProfile', ['username'=>Auth::user()->username, 'user'=>Auth::user()]) }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
