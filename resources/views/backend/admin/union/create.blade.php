				...
				<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						...
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							<!--begin::Page Title-->
							<h5 class="text-dark font-weight-bold my-1 mr-5">Add New Union</h5>
							<!--end::Page Title-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
								...
								<li class="breadcrumb-item active">
									<a class="text-muted">Add New Union</a>
								</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						...
						<div class="col-lg-12">
							...
							<div class="card card-custom example example-compact">
								<div class="card-header">
									<h3 class="card-title">Add New Union</h3>
								</div>
								
								
								<!--begin::Form-->
								<form class="form" action="{{route('admin.union.store')}}" method="post" id="kt_form_1">
									@csrf
									...
									<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-lg-5 col-sm-12">
												<input type="text" class="form-control" name="name_bn" placeholder="Enter Union Bangla Title" value="{{old('name_bn')}}" required/>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-5 col-sm-12">
												<input type="text" class="form-control" name="name_en" placeholder="Enter Union English Title" value="{{old('name_en')}}" required/>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-5 col-sm-12">
												<input type="text" class="form-control" name="union_bbs_code" placeholder="Enter Union Code" value="{{old('upazila_bbs_code')}}" required/>
											</div>
										</div>
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-lg-5 col-sm-12">
												<input type="text" class="form-control" name="upazila_bbs_code" id="upazila_bbs_code" value="--Select District First--" readonly="" required/>
											</div>
										</div>
