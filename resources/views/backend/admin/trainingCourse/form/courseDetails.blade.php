<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            <label class="col-form-label text-right col-lg-2 col-sm-12">Course Title<span class="text-danger">
                    *</span></label>
        ...
        <div class="form-group row">
            <label class="col-form-label text-right col-lg-2 col-sm-12">Fiscal Year<span class="text-danger">
                    *</span></label>
            <div class="col-lg-8 col-md-8 col-sm-12">
        ...
        <div class="form-group row">
            <label class="col-form-label text-right col-lg-2 col-sm-12">Trainer<span class="text-danger">
                    *</span></label>
            <div class="col-lg-8 col-md-8 col-sm-12">
        ...
        <div class="form-group row">
            <label class="col-form-label text-right col-lg-2 col-sm-12">Course Director</label>
            <div class="col-lg-8 col-md-8 col-sm-12">
        ...
        <div class="form-group row">
            <label class="col-form-label text-right col-lg-2 col-sm-12">Course Coordinator<span class="text-danger">
                    *</span></label>
            <div class="col-lg-8 col-md-8 col-sm-12">
        ...
        <div class="form-group row">
            <label class="col-form-label text-right col-lg-2 col-sm-12">Course Purpose<span class="text-danger">
                    *</span></label>
            <div class="col-lg-8 col-md-8 col-sm-12">
                <textarea type="text"
