                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom example example-compact">
                            <div class="card-header">
                                <h3 class="card-title">Show course details</h3> 
                            </div>
                                        ...
                                        @if ($course->courseDuration->count() > 0)
                                            <div class="table-responsive mt-10">
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        @foreach ($course->courseDuration as $courseDuration)
                                                            <tr>
                            ...
                            <div class="container mt-2 mb-2">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        @if ($course->courseCurriculam->count() > 0)
                                            <div class="table-responsive mt-10">
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        @foreach ($course->courseCurriculam as $courseCurriculam)
                                                            <tr>
