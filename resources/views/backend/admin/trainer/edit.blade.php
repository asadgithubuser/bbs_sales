                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item active">
                            <a class="text-muted">Edit Trainer</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom example example-compact">
                        ...
                        <form class="form" action="{{route('admin.trainer.update', $trainer->id)}}" method="post" id="kt_form_1" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5 col-sm-12">
                                        ...
                                        @if($trainer->photo)
                                            <div class="image-input image-input-empty image-input-outline" id="kt_image_100" style="background-image: url({{asset('storage/trainers/'.$trainer->photo)}})">
                                                ...
                                                <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change Photo">
                                                    ...
                                                    <input type="file" name="photo" accept=".png, .jpg, .jpeg" value="{{$trainer->photo}}"/>
                                                </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5 col-sm-12">
                                        <input type="text" name="address" class="form-control" value="{{$trainer->address}}" required>
                                    </div>
                                </div>
