                        ...
                        <div class="card card-custom example example-compact">
                            <div class="row">
                                <div class="col-md-4 offset-md-8 mt-3">
                                    <a href="{{ route('admin.calender.dowloadCalendercy') }}" class="float-right btn mr-8 btn-primary btn-sm" title="show">Download Calender</a>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($courseCalendars as $courseCalendar )
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('admin.course.show', ['id' => $courseCalendar->course->id, 'type'=> 'details'])}}" class="btn btn-primary btn-sm" title="show"><i class="la la-eye"></i></a>
                                                </td>
                                            </tr>
                                        @empty  
                                            <tr>
