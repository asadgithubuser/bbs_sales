							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Edit EA</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											@can('all_eas')
												<li class="breadcrumb-item">
													<a href="{{route('admin.ea.index')}}" class="text-muted">Manage EAs</a>
												</li>
											@endcan
											
											<li class="breadcrumb-item active">
												<a class="text-muted">Edit {{ $ea->name_en }} EA</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<div class="col-lg-12">
										...
										<div class="card card-custom example example-compact">
											<div class="card-header">
												<h3 class="card-title">Edit {{ $ea->name_en }} EA</h3>
											</div>
											
											
											<!--begin::Form-->
											<form class="form" action="{{route('admin.ea.update', $ea->id)}}" method="post" id="kt_form_1">
												@csrf
                                                @method('patch')
												...
												<div class="card-body">
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-5 col-sm-12">
															<input type="text" class="form-control" name="name_bn" placeholder="Enter EA Bangla Title" value="{{$ea->name_bn}}" required/>
														</div>
													</div>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-5 col-sm-12">
															<input type="text" class="form-control" name="name_en" placeholder="Enter EA English Title" value="{{$ea->name_en}}" required/>
														</div>
													</div>

													<div class="form-group row">
														<label class="col-form-label text-right col-lg-4 col-sm-12">EA Code: <span class="text-danger">*</span></label>
														<div class="col-lg-5 col-sm-12">
															<input type="text" class="form-control" name="ea_code" placeholder="Enter EA Code" value="{{$ea->ea_code}}" required/>
														</div>
													</div>
														...
														<div class="col-lg-5 col-sm-12">
														 	<select class="form-control select2" name="division_id" id="division_id" required>
																@foreach ($divisions as $division)
																	<option value="{{ $division->id }}" {{ ($ea->division_id == $division->id) ? 'selected' : '' }}>{{ $division->name_en }}</option>
																@endforeach
														 	</select>
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-5 col-sm-12">
														 <select class="form-control select2" name="district_id" id="district_id" required>
															<option value="{{ $ea->district_id }}" selected>{{ $ea->district ? $ea->district->name_en : '' }}</option> 
														 </select>
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-5 col-sm-12">
														 <select class="form-control select2" name="upazila_id" id="upazila_id" required>
															<option value="{{ $ea->upazila_id }}" selected>{{ $ea->upazila ? $ea->upazila->name_en : '' }}</option> 
														 </select>
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-5 col-sm-12">
														 <select class="form-control select2" name="union_id" id="union_id" required>
															<option value="{{ $ea->union_id }}" selected>{{ $ea->union ? $ea->union->name_en : '' }}</option> 
														 </select>
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-5 col-sm-12">
														 <select class="form-control select2" name="mouza_id" id="mouza_id" required>
															<option value="{{ $ea->mouza_id }}" selected>{{ $ea->mouza ? $ea->mouza->name_en : '' }}</option> 
														 </select>
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-5 col-sm-12">
														 <select class="form-control select2" name="village_id" id="village_id" required>
															<option value="{{ $ea->village_id }}" selected>{{ $ea->village ? $ea->village->name_en : '' }}</option> 
														 </select>
														</div>
													</div>
