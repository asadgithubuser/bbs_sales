				...
				<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						...
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							<!--begin::Page Title-->
							<h5 class="text-dark font-weight-bold my-1 mr-5">Agriculture Survey Notifications </h5>
							<!--end::Page Title-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
								...
								{{-- @can('manage_agriculture') --}}
									<li class="breadcrumb-item">
										<a href="{{route('admin.agriSurveyNoti.index')}}" class="text-muted">Agriculture Survey Notifications </a>
									</li>
								{{-- @endcan --}}
								<li class="breadcrumb-item active">
									<a class="text-muted">Agriculture Survey Notifications</a>
								</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						...
						<div class="col-lg-12">
							...
							<div class="card card-custom example example-compact">
								...
								<div class="card-header">
									<h3 class="card-title">Agriculture Survey Notifications</h3>
                                ...
                                <div class="form-group card-body mb-0 pb-0">
                                    ...
                                    <form class="form-inline" action="{{route('admin.agriSurveyNoti.dateFilter')}}" method="POST">
                                        @csrf
								...
								<div class="card-body">
									<div class="table-responsive ajax-data-container pt-3">
										@include('backend.admin.agriculture.agriSurveyNoti.ajax.tableBody')                                    
									</div>
								</div>
								<!--end::table-->
							</div>
