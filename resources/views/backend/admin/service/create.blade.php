				...
				<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						...
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							<!--begin::Page Title-->
							<h5 class="text-dark font-weight-bold my-1 mr-5">নতুন পরিষেবা যোগ করুন</h5>
							<!--end::Page Title-->
							<!--begin::Breadcrumb-->
							<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
								...
								<li class="breadcrumb-item active">
									<a class="text-muted">নতুন পরিষেবা যোগ করুন</a>
								</li>
							</ul>
							<!--end::Breadcrumb-->
						</div>
						...
						<div class="col-lg-12">
							...
							<div class="card card-custom example example-compact">
								<div class="card-header">
									<h3 class="card-title">নতুন পরিষেবা যোগ করুন</h3>
								</div>
								
								
								<!--begin::Form-->
								<form class="form" action="{{route('admin.service.store')}}" method="post" id="kt_form_1">
									@csrf
													...
													<div class="col-sm-6" style="padding-left: 35px; padding-right:35px;">
														<div class="form-group row">
															<label class="col-form-label text-right">পরিষেবার নাম (বাংলায়): <span class="text-danger">*</span></label>
																...
																<input type="text" class="form-control" name="name_bn" placeholder="পরিষেবার বাংলা নাম লিখুন" value="{{old('name_bn')}}" required/>
														...
														<div class="form-group row">
															<label class="col-form-label text-right">পদক্রম: <span class="text-danger">*</span></label>
																...
																<input type="number" class="form-control" name="ordering" placeholder="পরিষেবা পদক্রম লিখুন" value="{{old('ordering')}}" required/>
													...
													<div class="col-sm-6" style="padding-left: 35px; padding-right:35px;">
														<div class="form-group row">
															<label class="col-form-label text-right">পরিষেবার নাম (ইংরেজিতে): <span class="text-danger">*</span></label>
																...
																<input type="text" class="form-control" name="name_en" placeholder="পরিষেবার ইংরেজি নাম লিখুন" value="{{old('name_en')}}" required/>
