                                                    ...
                                                    <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="total_fruity_trees_in_garden" style="font-size: 1.2em; font-weight: bold;"><b>চলতি বছরে বাগানে ফলবান গাছের সংখ্যা: </b><span class="text-danger">*</span></label>
                                                                        ...
                                                                        <input class="form-control total_fruity_trees" type="text" placeholder="" id="total_fruity_trees_in_garden" name="total_fruity_trees_in_garden" required/>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="total_fruity_scattered_trees" style="font-size: 1.2em; font-weight: bold;"><b>চলতি বছরে ফলবান বিক্ষিপ্ত গাছের সংখ্যা: </b><span class="text-danger">*</span></label>
                                                                        ...
                                                                        <input class="form-control total_fruity_trees" type="text" placeholder="" id="total_fruity_scattered_trees" name="total_fruity_scattered_trees" required/>
                                                                   
                                                                </div>

                                                                <div class="form-group row">
                                                                    <label for="land_amount_under_the_fruitly_trees" style="font-size: 1.5em; font-weight: bold;"><b>চলতি বছরে ফলবান গাছের অধীনে জমির আয়তন (একর) (বাগান): </b><span class="text-danger">*</span></label>
                                                                   
                                                                        <input class="form-control total_land_amount_under_the_trees" type="text" placeholder="একর" id="land_amount_under_the_fruitly_trees" name="land_amount_under_the_fruitly_trees" required/>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="total_fruity_trees" style="font-size: 1.2em; font-weight: bold;"><b>চলতি বছরে মোট  ফলবান গাছের সংখ্যা: </b></label>
                                                                        ...
                                                                        <input class="form-control average_yield_per_tree" type="text" id="total_fruity_trees" name="total_fruity_trees" readonly/>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="total_production" style="font-size: 1.2em; font-weight: bold;"><b>চলতি বছরে মোট উৎপাদন (মেট্রিক টন): </b><span class="text-danger">*</span></label>
                                                                        ...
                                                                        <input class="form-control average_yield_per_tree" type="text" placeholder="Enter Current Yeart Total Production" id="total_production" name="total_production" required/>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="total_fruitless_trees" style="font-size: 1.2em; font-weight: bold;"><b>মোট ফলবিহীন গাছের সংখ্যা: </b><span class="text-danger">*</span></label>
                                                                        ...
                                                                        <input class="form-control" type="text" placeholder="" id="total_fruitless_trees" name="total_fruitless_trees" required/>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="land_amount_under_the_fruitless_trees" style="font-size: 1.2em; font-weight: bold;"><b>চলতি বছরে ফলবিহীন গাছের অধীন জমির আয়তন (একর): </b><span class="text-danger">*</span></label>
                                                                        ...
                                                                        <input class="form-control total_land_amount_under_the_trees" type="text" placeholder="একর" id="land_amount_under_the_fruitless_trees" name="land_amount_under_the_fruitless_trees" required/>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="total_land_amount_under_the_trees" style="font-size: 1.2em; font-weight: bold;"><b>চলতি বছরে মোট গাছের অধীন জমির আয়তন (একর): </b></label>
                                                                        ...
                                                                        <input class="form-control" type="text" id="total_land_amount_under_the_trees" name="total_land_amount_under_the_trees" readonly/>
                                                    ...
                                                    <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="farmers_mobile" style="font-size: 1.2em; font-weight: bold;"><b>মোবাইল নম্বর: </b></label>
                                                                ...
                                                                <input class="form-control" type="text" id="farmers_mobile" name="farmers_mobile" />
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="last_total_fruity_trees_in_garden" style="font-size: 1.2em; font-weight: bold;"><b>গত বছরে বাগানে ফলবান গাছের সংখ্যা: </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control last_total_fruity_trees" type="text" placeholder="" id="last_total_fruity_trees_in_garden" name="last_total_fruity_trees_in_garden" required/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="last_total_fruity_scattered_trees" style="font-size: 1.2em; font-weight: bold;"><b>গত বছরে ফলবান বিক্ষিপ্ত গাছের সংখ্যা: </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control last_total_fruity_trees" type="text" placeholder="" id="last_total_fruity_scattered_trees" name="last_total_fruity_scattered_trees" required/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="last_land_amount_under_the_fruitly_trees" style="font-size: 1.2em; font-weight: bold;"><b>গত বছরে ফলবান গাছের অধীনে জমির আয়তন (একর): </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control last_total_land_amount_under_the_trees" type="text" placeholder="একর" id="last_land_amount_under_the_fruitly_trees" name="last_land_amount_under_the_fruitly_trees" required/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="last_total_fruity_trees" style="font-size: 1.2em; font-weight: bold;"><b>গত বছরে মোট  ফলবান গাছের সংখ্যা: </b></label>
                                                                ...
                                                                <input class="form-control" type="text" id="last_total_fruity_trees" name="last_total_fruity_trees" readonly/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="last_total_production" style="font-size: 1.2em; font-weight: bold;"><b>গত বছরে মোট উৎপাদন (মেট্রিক টন): </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control" type="text" placeholder="Enter last Year Total Production" id="last_total_production" name="last_total_production" required/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="average_yield_per_tree" style="font-size: 1.2em; font-weight: bold;"><b>গাছ প্রতি গড় ফলন (কেজি):</b></label>
                                                                ...
                                                                <input class="form-control" type="text" id="average_yield_per_tree" name="average_yield_per_tree" readonly/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="last_land_amount_under_the_fruitless_trees" style="font-size: 1.2em; font-weight: bold;"><b>গত বছরে ফলবিহীন গাছের অধীন জমির আয়তন (একর): </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control last_total_land_amount_under_the_trees" type="text" placeholder="একর" id="last_land_amount_under_the_fruitless_trees" name="last_land_amount_under_the_fruitless_trees" required/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="last_total_land_amount_under_the_trees" style="font-size: 1.2em; font-weight: bold;"><b>গত বছরে মোট গাছের অধীন জমির আয়তন (একর): </b></label>
                                                                ...
                                                                <input class="form-control" type="text" id="last_total_land_amount_under_the_trees" name="last_total_land_amount_under_the_trees" readonly/>
