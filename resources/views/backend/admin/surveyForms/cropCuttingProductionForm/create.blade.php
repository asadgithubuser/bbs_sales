                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6" style="padding-left: 40px; padding-right:30px;">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <select class="select2 form-control form-control-lg"
                                                                ...
                                                                <option value="">--মৌজা অবস্থান নির্বাচন করুন--
                                                                </option>
                                                    ...
                                                    <div class="col-md-6" style="padding-left: 30px; padding-right:40px;">
                                                        ...
                                                        <div class="form-group row" id="cluster_id_id"
                                                            style="display: none;">
                                                            <label for="" class="col-md-12"
                                                                style="font-size: 1.5em; font-weight: bold;"><b>দাগগুচ্ছের
                                                                    নাম্বার: </label>
                                                            <select class="select2 form-control col-md-12"
                                                                id="cluster_area_acre" name="cluster_name">
                                                                <option value="">--দাগগুচ্ছের নাম্বার নির্বাচন করুন--
                                                                </option>
                                                            ...
                                                            @if (isset($surveyNotification))
                                                                ...
                                                                @else
                                                                    <select class="select2 form-control form-control-lg"
                                                                        ...
                                                                        <option value="">--ফসল নির্বাচন করুন--
                                                                        </option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <select class="select2 form-control form-control-lg"
                                                                        id="type_of_cultivation"
                                                                        name="type_of_cultivation" required>
                                                            ...
                                                            <div class="col-md-6"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <select class="select2 form-control form-control-lg"
                                                                        id="crop_type_code" name="crop_type_code"
                                                                        required>
                                                            ...
                                                            <div class="col-md-6"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <input class="form-control" type="number"
                                                                        ...
                                                                        name="plot_corner_point_1"
                                                                        id="plot_corner_point_1" required />

                                                                </div>

                                                                <div class="form-group row">
                                                                    <label for="point_1_number"
                                                                        style="font-size: 1.5em; font-weight: bold;"><b
                                                                            class="point_1_number_label">উভয়
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <input class="form-control" type="number"
                                                                        step="0.01" name="point_1_random"
                                                                        id="point_1_random" readonly />
                                                            ...
                                                            <div class="col-md-6"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <input class="form-control" type="number"
                                                                        ...
                                                                        name="plot_corner_point_2"
                                                                        id="plot_corner_point_2" required />
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="point_2_number"
                                                                        style="font-size: 1.5em; font-weight: bold;"><b
                                                                            class="point_2_number_label">উভয়
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6" style="padding-left: 40px; padding-right:30px;">
                                                        ...
                                                        <div class="form-group row paddy_block">
                                                            <label for="after_harvesting_paddy_kg"
                                                                style="font-size: 1.5em; font-weight: bold;"><b>ধান কর্তনের
                                                                    ...
                                                                    (কেজি): </b><span class="text-danger">*</span></label>
                                                        ...
                                                        <div class="source_of_water_block">

                                                            <div class="form-group row">
                                                                <label for="source_of_water"
                                                                    style="font-size: 1.5em; font-weight: bold;"><b>পানির
                                                                        উৎসের কোড

                                                                    </b><span class="text-danger">*</span></label>

                                                                <select class="select2 form-control form-control-lg"
                                                                    id="source_of_water" name="source_of_water" required>
                                                                    <option value="">--নির্বাচন করুন--</option>
                                                                    <option value="1">প্রাকৃতিক</option>
                                                                    <option value="2">যান্ত্রিক</option>
                                                    ...
                                                    <div class="col-md-6" style="padding-left: 30px; padding-right:40px;">
                                                        ...
                                                        <div class="form-group row paddy_block">
                                                            ...
                                                            <input class="form-control" type="number" step="0.01"
                                                                placeholder="" name="paddy_moisture"
                                                                id="paddy_moisture" />
                                                        ...
                                                        <div class="source_of_water_block">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="is_water_irrigation_both"
                                                                    style="font-size: 1.5em; font-weight: bold;"><b>পানির
                                                                        সেচ পর্যাপ্ত ছিল কি?
                                                                ...
                                                                <select class="select2 form-control form-control-lg"
                                                                    id="is_water_irrigation_both"
                                                                    name="is_water_irrigation_both" required>
                                                                    <option value="">--নির্বাচন করুন--</option>
                                                    ...
                                                    <div class="col-md-6" style="padding-left: 40px; padding-right:30px;">
                                                        ...
                                                        <div class="form-group row fertilizer_type_block"
                                                            ...
                                                            <label for="what_type_fertilizer"
                                                                ...
                                                                class="col-3 col-form-label"><b>কোন ধরনের সার ব্যবহার
                                                                    হয়েছে:
                                                                </b><span class="text-danger">*</span></label>
                                                            <div class="col-9">
                                                                <div class="form-group">
                                                                    <select class="select2 form-control form-control-lg"
                                                                        ...
                                                                        <option value="1">রাসায়নিক</option>
                                                                        <option value="2">জৈব</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row fertilizer_type_block"
                                                            ...
                                                            <label for="what_used_fertilizer"
                                                                style="font-size: 1.5em; font-weight: bold;"
                                                                class="col-3 col-form-label"><b>ব্যবহারকৃত সারের নাম:
                                                                </b><span class="text-danger">*</span></label>
                                                            <div class="col-9">
                                                                <div class="form-group">
                                                                    <select
                                                        ...
                                                        <div class="form-group row other_shar" style="display: none">
                                                            <label for="what_type_fertilizer"
                                                                style="font-size: 1.5em; font-weight: bold;"
                                                                class="col-3 col-form-label"><b> অন্যান্য: </b></label>
                                                            <div class="col-9">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control"
                                                                        name="other_fertilizers" id="other_fertilizers"
                                                                        placeholder="Other Fertilizer">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row fertilizer_type_block"
                                                            style="display: none">
                                                            <label for="fertilizer_amound" class="col-3 col-form-label"
                                                                style="font-size: 1.5em; font-weight: bold;"><b>সারের
                                                                    পরিমাণ (কেজি):
                                                                </b><span class="text-danger">*</span></label>
                                                            <div class="col-9">
                                                                <input class="form-control" type="number" step="0.01"
                                                        ...
                                                        <div class="form-group row pesticide_type_block"
                                                            style="display: none">
                                                            <label for="what_type_pesticide" class="col-3 col-form-label"
                                                                style="font-size: 1.5em; font-weight: bold;"><b>কি ধরনের
                                                                    কীটনাশক:
                                                                </b><span class="text-danger">*</span></label>
                                                            <div class="col-9">
                                                                <div class="form-group">
                                                                    <select class="select2 form-control form-control-lg"
                                                                        id="what_type_pesticide"
                                                                        name="what_type_pesticide">
                                                                        <option value="">--কীটনাশকের ধরণ--</option>
                                                                        <option value="1">Natural (প্রাকৃতিক)</option>
                                                                        <option value="2">Mechanical (যান্ত্রিক)
                                                                        </option>
                                                        ...
                                                        <div class="form-group row pesticide_type_block"
                                                            style="display: none">
                                                            <label for="pesticide_amound" class="col-3 col-form-label"
                                                                style="font-size: 1.5em; font-weight: bold;"><b>কীটনাশক
                                                                    পরিমাণ (কেজি): </b><span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-9">
                                                                <input class="form-control" type="number" step="0.01"
                                                        ...
                                                        <div class="form-group row pesticide_type_block"
                                                            ...
                                                            <div class="col-9">
                                                                <input class="form-control" type="number" step="0.01"
                                                                    ...
                                                                    name="pesticide_amound_lit"
                                                                    id="pesticide_amound_lit" />
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <td style="width: 10%">
                                                                        <div class="text-left">
                                                                            ...
                                                                            <select
                                                                                ...
                                                                                id="comments_1" name="comments[]"
                                                                                required>
                                                                                <option value="">--মন্তব্য নির্বাচন
                                                                                    করুন--
                                                                                </option>
...
@push('stackScript')
    ...
    <script>
        ...
        $('#what_used_fertilizer').on('change', function() {
            let what_type_fertilizer = $(this).val();
            
            if (what_type_fertilizer == 7) {
                $('.other_shar').show();
                
                $('#other_fertilizers').attr('required', 'required');


            } else if (what_type_fertilizer == 2) {
                $('.other_shar').hide();

                $('#other_fertilizers').removeAttr('required');
