                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle">Select Mouza for Crop Cutting Production Form Survey</h5>
                                    ...
                                    <div class="col-md-3 w3-animate-right1">
                                        <div class="w3-card w3-hover-shadow">
                                            <div class="card-body w3-green">
                                                ...
                                                <a href="{{ route('admin.cropCuttingProductionForm.create', ['surveyProListId' => $processList->id]) }}">
