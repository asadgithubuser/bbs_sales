                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <input class="form-control" type="date"
                                                                ...
                                                                name="crop_cutting_date" id="crop_cutting_date" disabled />
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <select class="select2 form-control form-control-lg"
                                                                id="in_cluster" name="in_cluster" disabled>
                                                    ...
                                                    <div class="col-md-6"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <select class="select2 form-control form-control-lg"
                                                                id="farmer_id" name="farmer_id" disabled>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            @if (isset($surveyNotification))
                                                                ...
                                                                @else
                                                                    <select class="select2 form-control form-control-lg"
                                                                        id="crop_id" name="crop_id" disabled>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <select class="select2 form-control form-control-lg"
                                                                        id="crop_type_code" name="crop_type_code" disabled>
                                                            ...
                                                            <div class="col-md-12"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="number" step="0.01"
                                                                        ...
                                                                        name="amount_of_land" id="amount_of_land" disabled
                                                            ...
                                                            <div class="col-md-6"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <input class="form-control" type="number" step="0.01"
                                                                        ...
                                                                        name="point_1_number" id="point_1_number" readonly
                                                            ...
                                                            <div class="col-md-6"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <input class="form-control" type="number" step="0.01"
                                                                        ...
                                                                        name="point_2_number" id="point_2_number" readonly
                                                    ...
                                                    <div class="col-md-6"
                                                        ...
                                                        <div class="form-group row paddy_block">
                                                            ...
                                                            <input class="form-control" type="number" step="0.01"
                                                                ...
                                                                id="after_harvesting_paddy_kg" readonly
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <select class="select2 form-control form-control-lg"
                                                                id="water_irrigation" name="water_irrigation" disabled>
