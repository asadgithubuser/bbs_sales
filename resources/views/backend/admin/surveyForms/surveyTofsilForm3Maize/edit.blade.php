                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom example example-compact">
                            <div class="card card-custom gutter-b example example-compact">
                                ...
                                <!--begin::Form-->
                                <form action="{{ route('admin.surveyTofsilForm3Maize.update',$surveyTofsilForm3MaizeData) }}" method="post">
                                    @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="season" style="font-size: 1.5em; font-weight: bold;"><b>ফসলের জাত: </b><span class="text-danger">*</span></label>
                                                        
                                                                <select class="select2 form-control form-control-lg" id="season" name="season" required>
                                                    ...
                                                    <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="" style="font-size: 1.5em; font-weight: bold;"><b>তথ্য সংগ্রহের তারিখ: </b></label>
                                                                ...
                                                                <input class="form-control" type="text" id="" name="" value="{{ date('jS \of F Y') }}" readonly/>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                        <div class="form-group row">
                                                            <label for="crop_id" style="font-size: 1.5em; font-weight: bold;"><b>ফসলের নাম: </b><span class="text-danger">*</span></label>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="last_year_land_amount" style="font-size: 1.5em; font-weight: bold;"><b>গত বছরে জমির পরিমাণ (একর): </b><span class="text-danger">*</span></label>
                                                            
                                                                <input class="form-control" type="text" placeholder="একর" id="last_year_land_amount" name="last_year_land_amount" value="{{ $surveyTofsilForm3MaizeData->last_year_land_amount }}" required/>
                                                           
                                                        </div>

                                                        <div class="form-group row">
                                                            <label for="last_year_land_producttion" style="font-size: 1.5em; font-weight: bold;"><b>গত বছরে একর প্রতি ফলন (কেজি): </b><span class="text-danger">*</span></label>
                                                            
                                                                <input class="form-control lastacreCalculate" type="text" placeholder="কেজি" id="last_year_land_producttion" value="{{ $surveyTofsilForm3MaizeData->last_year_land_producttion }}" name="last_year_land_producttion" required/>
                                                            
                                                        </div>

                                                        <div class="form-group row">
                                                            <label for="last_acre_reflection_rate" style="font-size: 1.5em; font-weight: bold;"><b>গত বছরে মোট উৎপাদন (ম্যাট্ট্রিক টন): </b><span class="text-danger">*</span></label>
                                                            
                                                                <input class="form-control lastacreCalculate" type="text"  id="last_acre_reflection_rate" name="last_acre_reflection_rate" value="{{ $surveyTofsilForm3MaizeData->last_acre_reflection_rate }}" readonly/>
                                                    ...
                                                    <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="current_year_land_amount" style="font-size: 1.5em; font-weight: bold;"><b>চলতি বছরে জমির পরিমাণ (একর): </b><span class="text-danger">*</span></label>
                                                            
                                                                <input class="form-control acreCalculate" value="{{ $surveyTofsilForm3MaizeData->current_year_land_amount }}" type="text" placeholder="একর" id="current_year_land_amount" name="current_year_land_amount" required/>
                                                           
                                                        </div>

                                                        <div class="form-group row">
                                                            <label for="current_year_land_producttion" style="font-size: 1.5em; font-weight: bold;"><b>চলতি বছরে একর প্রতি ফলন (কেজি): </b><span class="text-danger">*</span></label>
                                                            
                                                                <input class="form-control acreCalculate" type="text" placeholder="কেজি" id="current_year_land_producttion" value="{{ $surveyTofsilForm3MaizeData->current_year_land_producttion }}" name="current_year_land_producttion" required/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="acre_reflection_rate" style="font-size: 1.5em; font-weight: bold;"><b>চলতি বছরে মোট উৎপাদন (ম্যাট্ট্রিক টন): </b><span class="text-danger">*</span></label>
                                                            
                                                                <input class="form-control" type="text" value="{{ $surveyTofsilForm3MaizeData->acre_reflection_rate }}" id="acre_reflection_rate" name="acre_reflection_rate" readonly/>
