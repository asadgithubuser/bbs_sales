                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12" style="padding-left: 30px; padding-right:30px;">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="cluster_type"  style="font-size: 1.5em; font-weight: bold;"><b>দাগগুচ্ছের অবস্থা: </b><span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="form-group row" id="cluster_no" style="display: none">
                                                                <label for="cluster_id"  style="font-size: 1.5em; font-weight: bold;"><b>দাগগুচ্ছের নাম: </b><span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <select id="permanent_crop_ids" name="permanent_crop_ids[]" class="form-control select-multiple-additional" multiple required>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <select id="temporary_crop_ids" name="temporary_crop_ids[]" class="form-control select-multiple-additional" multiple required>
                                                                    @foreach ($crops as $crop)
                                                                        <option value="{{ $crop->id }}">{{ ucfirst($crop->name_en) }}</option>
                                                                    @endforeach
                                                                </select>
                                                ...
                                                <div class="col-md-6 col-sm-12" style="padding-left: 30px; padding-right:30px;">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="land_amount"  style="font-size: 1.2em; font-weight: bold;"><b>চাষকৃত জমির আকার: </b><span class="text-danger">*</span></label>
                                                                    ...
                                                                    <input id="land_amount" name="land_amount" class="form-control" type="text" placeholder="জমির আকার (একর)" required/>	
