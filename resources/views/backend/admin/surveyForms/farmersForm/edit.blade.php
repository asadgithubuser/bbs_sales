                            ...
                            <form action="{{ route('admin.farmersForm.update', $farmerData->id) }}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    {{-- @if (!empty($processList)) --}}
                                        ...
                                        <input type="hidden" name="division_id" value="{{ $farmerData->division ? $farmerData->division->name_en : '' }}"/>
                                        <input type="hidden" name="district_id"  value="{{ $farmerData->district ? $farmerData->district->name_en : '' }}" />
                                        <input type="hidden" name="upazila_id" value="{{ $farmerData->upazila ? $farmerData->upazila->name_en : '' }}" />
                                        <input type="hidden" name="union_id" value="{{ $farmerData->union ? $farmerData->union->name_en : '' }}" />
                                        <input type="hidden" name="mouza_id" value="{{ $farmerData->mouza ? $farmerData->mouza->name_en : '' }}" />
                                    {{-- @endif --}}
                                    ...
                                    <div class="card p-3" style="text-align: center;font-size: 1.2em; font-weight: bold;">
                                        ...
                                        <p><b>মৌজা:  @isset($farmerData) {{ $farmerData->union ? $farmerData->union->name_en : '' }} @endisset</b><br>
                                        <b>ইউনিয়ন: @isset($farmerData) {{ $farmerData->mouza ? $farmerData->mouza->name_en : '' }} @endisset</b></p>
                                    </div>
                                    <div class="card">
                                        <div class="card-body w3-light-gray">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12" style="padding-left: 30px; padding-right:30px;">
                                                    ...
                                                    <div class="form-group row" style="display:none;">
                                                        ...
                                                        <div class="col-9">
                                                            <div class="form-group">
                                                                <input id="union_id" class="form-control" type="hidden" @isset($farmerData) value="{{ $farmerData->union ? $farmerData->union->name_en : '' }}" @endisset readonly/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row" style="display:none;">
                                                        ...
                                                        <div class="col-9">
                                                            <div class="form-group">
                                                                <input id="mouza_id" class="form-control" type="hidden" @isset($farmerData) value="{{ $farmerData->mouza ? $farmerData->mouza->name_en : '' }}" @endisset readonly/>
                                                    ...
                                                    <div class="form-group row" style="display: none;">
                                                        <label for="cluster_type"  style="font-size: 1.2em; font-weight: bold;"><b>দাগগুচ্ছের অবস্থা: </b><span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="form-group row" id="cluster_no" style="display: none">
                                                        <label for="cluster_id"  style="font-size: 1.2em; font-weight: bold;"><b>দাগগুচ্ছের নাম: </b><span class="text-danger">*</span></label>
                                                                <select id="cluster_id" class="form-control" name="cluster_id">
                                                                
                                                                    @foreach ($clusters as $cluster)
                                                                        <option @if ($cluster->id == $farmerData->cluster_id) selected @endif value="{{$cluster->id}}">{{$cluster->name_en}}</option>
                                                                    @endforeach
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="food_type"  style="font-size: 1.2em; font-weight: bold;"><b>খানার প্রকার: </b><span class="text-danger">*</span></label>
                                                                <select id="food_type" name="food_type" class="form-control" required>
                                                                        ...
                                                                        <option @if ($farmerData->food_type == 2) selected @endif value="2" selected>অকৃষি</option>
                                                                        <option @if ($farmerData->food_type == 1) selected @endif value="1">কৃষি</option> 
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <input id="farmers_mobile" name="farmers_mobile" class="form-control" type="number" @isset($farmerData) value="{{ $farmerData->farmers_mobile}}" @endisset/>	
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <select name="food_type" class="form-control form-control-lg" required>

                                                            @if ($farmerData->food_type == 1)
                                                                <option value="2">Non-Agricultural</option>   
                                                                <option value="1" selected>Agricultural</option> 
                                                            @elseif($farmerData->food_type == 2)
                                                                <option value="2" selected>Non-Agricultural</option>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <input name="farmers_name" class="form-control" type="text" value="{{$farmerData->farmers_name}}" required />	
                                                        
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="farmers_mobile" style="font-size: 1.2em; font-weight: bold;"><b>মোবাইল নাম্বার: </b></label>
                                                        
                                                        <input name="farmers_mobile" class="form-control" type="number" value="{{$farmerData->farmers_mobile}}" />	
                                                        
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="permanent_crop_ids" style="font-size: 1.5em; font-weight: bold;"><b>স্থায়ী ফসল: </b><span class="text-danger">*</span></label>
                                                        {{-- <div class="col-9"> --}}
                                                            {{-- <div class="form-group"> --}}
                                                                <select name="permanent_crop_ids[]" id="permanent_crop_ids" class="form-control select-multiple-additional" multiple required>
                                                ...
                                                <div class="col-md-6 col-sm-12" style="padding-left: 30px; padding-right:30px;">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="farmers_name"  style="font-size: 1.2em; font-weight: bold;"><b>খানা প্রধানের নাম: </b><span class="text-danger">*</span></label>
                                                            ...
                                                            <input id="farmers_name" name="farmers_name" class="form-control" type="text" @isset($farmerData) value="{{ $farmerData->farmers_name}}" @endisset required />	
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="farmers_class_division_type" style="font-size: 1.2em; font-weight: bold;"><b>কৃষকের শ্রেণি বিভাগ: </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <select id="farmers_class_division_type" name="farmers_class_division_type" class="form-control form-control-lg" required>
                                                                    {{-- <option value="">--চাষকৃত জমির পরিমাণ--</option> --}}
                                                                    <option @if ($farmerData->farmers_class_division_type == 1) selected @endif value="1">ক্ষুদ্র কৃষক(০.৫-২.৪৯ একর)</option>
                                                                    <option  @if ($farmerData->farmers_class_division_type == 2) selected @endif value="2">মাঝারি কৃষক(২.৫০-৭.৪৯ একর)</option>
                                                                    <option  @if ($farmerData->farmers_class_division_type == 3) selected @endif value="3">বড় কৃষক(৭.৫০ তদূর্ধ্ব একর জমি)</option>
                                                                </select>
                                                            
                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="land_amount"  style="font-size: 1.2em; font-weight: bold;"><b>জমির আকার: </b><span class="text-danger">*</span></label>
                                                    
                                                            <input id="land_amount" name="land_amount" class="form-control" @isset($farmerData) value="{{ $farmerData->land_amount}}" @endisset type="text" placeholder="জমির আকার" required/>	
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <input name="father_name" class="form-control" type="text" value="{{ $farmerData->father_name }}" required />	
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="village_name" style="font-size: 1.5em; font-weight: bold;"><b>গ্রামের নাম: </b><span class="text-danger">*</span></label>
                                                            ...
                                                            <input name="village_name" class="form-control" type="text" value="{{ $farmerData->village_name }}" required />	
                                                        
                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="temporary_crop_ids" style="font-size: 1.5em; font-weight: bold;"><b>অস্থায়ী ফসল: </b><span class="text-danger">*</span></label>
                                                        
                                                            <select name="temporary_crop_ids[]" id="temporary_crop_ids" class="form-control select-multiple-additional" multiple required>
                                                    ...
                                                    <input id="farmers_class_division_type_val" name="farmers_class_division_type" class="form-control" type="hidden" value=""/>
                                            ...
                                            <input id="union_id" name="union_id" class="form-control" type="hidden" value="{{ $farmerData->union ? $farmerData->union->name_en : '' }}" disabled/>
                                            @if ($farmerData->mouza)
                                                <input id="mouza_id" name="mouza_id" class="form-control" type="hidden" value="{{ $farmerData->mouza ? $farmerData->mouza->name_en : '' }}" disabled/>
                                            @endif
                                            <input id="cluster_id" name="cluster_id" class="form-control" type="hidden" value="{{ $farmerData->cluster ? $farmerData->cluster->name_en : '' }}" disabled/>
