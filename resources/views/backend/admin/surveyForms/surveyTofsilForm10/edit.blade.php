                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom example example-compact">
                            <div class="card card-custom gutter-b example example-compact">
                                ...
                                <!--begin::Form-->
                                <form action="{{ route('admin.surveyTofsilForm10.update',$surveyTofsilForm10Datae) }}" method="post">
                                    @csrf
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="collection_start_date"
                                                                style="font-size: 1.5em; font-weight: bold;"><b>তথ্য
                                                                    সংগ্রহের তারিখ শুরু: </b><span
                                                                    class="text-danger">*</span></label>

                                                            <input class="form-control" type="date" placeholder="শুরু"
                                                    ...
                                                    <div class="col-md-6"
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="collection_end_date"
                                                                style="font-size: 1.5em; font-weight: bold;"><b>তথ্য
                                                                    সংগ্রহের শেষ তারিখ: </b><span
                                                                    class="text-danger">*</span></label>

                                                            <input class="form-control" type="date" placeholder="শেষ"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6"
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="previous_year_land_amound_desi"
                                                                style="font-size: 1.5em; font-weight: bold;"><b>গত বছরে দেশী
                                                                    ফসলের অধীনে জমির পরিমাণ (একরে): </b><span
                                                                    class="text-danger">*</span></label>

                                                            <input class="form-control" type="number" step="0.01"
                                                                placeholder="" name="previous_year_land_amound_desi"
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="current_year_land_amound_desi"
                                                                style="font-size: 1.5em; font-weight: bold;"><b>চলতি বছরে
                                                                    দেশী ফসলের অধীনে জমির পরিমাণ (একরে): </b><span
                                                                    class="text-danger">*</span></label>

                                                            <input class="form-control" type="number" step="0.01"
                                                                placeholder="" name="current_year_land_amound_desi"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <textarea class="form-control" name="note_desi" id="note_desi" rows="3" required>{!! $surveyTofsilForm10Datae->note_desi !!}</textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6"
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="temporary_crop_land_amound"
                                                                style="font-size: 1.5em; font-weight: bold;"><b>অস্থায়ী
                                                                    ফসলের জমির পরিমাণ (একরে): </b><span
                                                                    class="text-danger">*</span></label>

                                                            <input class="form-control" type="number" step="0.01"
                                                                placeholder="" name="temporary_crop_land_amound"
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="current_year_land_amound_upashi"
                                                                style="font-size: 1.5em; font-weight: bold;"><b>চলতি বছরে
                                                                    উফশী ফসলের অধীনে জমির পরিমাণ (একরে): </b><span
                                                                    class="text-danger">*</span></label>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <textarea class="form-control" name="note_upashi" id="note_upashi" rows="3"
                                                                ...
                                                                <tr id="rec-1">
                                                                    ...
                                                                    <td>
                                                                        <div class="text-left">
                                                                            ...
                                                                            <input class="form-control" type="number"
                                                                                step="0.01" placeholder="মে. টন"
                                                                                name="previous_total_production[]"
                                                                                id="previous_total_production_1" />
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="input-group-btn text-left ml-2">
                                                                            <button
                                                                                ...
                                                                                type="button"
                                                                                style="padding: 0.75rem">Add</button>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
