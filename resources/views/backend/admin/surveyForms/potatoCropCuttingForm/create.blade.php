                            ...
                            <div class="card card-custom gutter-b example example-compact">
                                ...
                                <form action="{{ route('admin.potatoCropCutting.store') }}" method="post">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="row">
                                                        <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <select class="select2 form-control form-control-lg" id="farmer_id" name="farmer_id" required>
                                                                    ...
                                                                    @if (isset($surveyList->surveyCompilationCollectForms))
                                                                        @foreach ($surveyList->shankalanfarmers($processList->mouja_id) as $item)
                                                            ...
                                                            <div class="form-group row" id="land_segment_signal_field" style="display: none;">
                                                                ...
                                                                <input class="form-control" type="text" placeholder="ভূমি খন্ডের সংক্ষেত নং" name="land_segment_signal" id="land_segment_signal" required/>
                                                        ...
                                                        <div class="col-md-6" style="padding-left: 35px; padding-right:35px;"> 
                                                            ...
                                                            {{-- <div class="form-group row">
                                                                ...
                                                                <input type="text" id="in_cluster" value="" class="form-control form-control-lg">
                                                            ...
                                                            <div class="form-group row" id="cluster_filed" style="display: none;">
                                                                <label for="in_cluster" style="font-size: 1.2em; font-weight: bold;"><b>মৌজার অবস্থান: </b><span class="text-danger">*</span></label>
                                                                <input type="text" id="in_cluster" class="form-control form-control-lg" name="in_cluster" value="">
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="crop_cutting_date" style="font-size: 1.2em; font-weight: bold;"><b>তথ্য সংগ্রহের তারিখ: </b><span class="text-danger">*</span></label>
                                                                    ...
                                                                    <input class="form-control" type="date" placeholder="Enter Crop Cutting Date" value="{{ date('Y-m-d') }}" name="crop_cutting_date" id="crop_cutting_date" readonly required/>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 average" style="padding-left: 35px; padding-right:35px;"> 
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="location_of_sample_row_2"style="font-size: 1.5em; font-weight: bold;"><b>২য় নমুনা সারির অবস্থান (তম): </b><span class="text-danger">*</span></label>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="row_length_feet_2"style="font-size: 1.5em; font-weight: bold;"><b>২য় নমুনা সারির দৈর্ঘ (ফুট): </b><span class="text-danger">*</span></label>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="row_average_width_feet_2"style="font-size: 1.5em; font-weight: bold;"><b>২য় নমুনা সারির গড় প্রস্থ (ফুট): </b><span class="text-danger">*</span></label>
                                        ...
                                        <div class="text-center" style="background-color: #134f1f; padding: 10px;">
                                            <h3 style="color:#ffffff;">আলুর ফলন/উৎপাদন হার </h3>
                                        </div>
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                        ...
                                        <div class="text-center" style="background-color: #134f1f; padding: 10px;">
                                            <h3 style="color:#ffffff;">আলুর ফলন/উৎপাদন  খরচ</h3>
                                        </div>
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                    <div class="row">
                                                        <div class="form-group row">
                                                            ...
                                                            <input class="form-control" type="text" placeholder="একর প্রতি আলুর উৎপাদন খরচ" name="production_cost_per_acre" id="production_cost_per_acre" required/>
