                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom example example-compact">
                            ...
                            <!--begin::Form-->
                            <form action="{{ route('admin.potatoCropCutting.update', $potatoData) }}" method="post">
                                @csrf
                                                ...
                                                <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="farmer_id"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>বর্তমান ভূমি
                                                                খন্ড ব্যাবহারকারী/চাষির নাম: </b><span
                                                                class="text-danger">*</span></label>
                                                        <select class="select2 form-control form-control-lg" id="farmer_id"
                                                            name="farmer_id" required>
                                                            @if ($potatoData->farmer_id)
                                                                <option value="{{ $potatoData->farmer_id }}" selected>
                                                                    {{ $potatoData->farmer ? $potatoData->farmer->farmers_name : '' }}
                                                                </option>
                                                                ...
                                                                @endif
                                                            @else
                                                                <option value="">--ব্যাবহারকারী/চাষির নাম নির্বাচন
                                                                    করুন--</option>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="land_segment_signal"
                                                            style="font-size: 1.5em; font-weight: bold;"><b> ভূমি খন্ডের
                                                                সংক্ষেত নং: </b><span class="text-danger">*</span></label>

                                                        <input class="form-control" type="text" placeholder=""
                                                            name="land_segment_signal" id="land_segment_signal"
                                                            value="{{ $potatoData->land_segment_signal }}" required />
                                                ...
                                                <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="in_cluster"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>মৌজার
                                                                অবস্থান: </b><span class="text-danger">*</span></label>

                                                        <select class="select2 form-control form-control-lg" id="in_cluster"
                                                            name="in_cluster" required>
                                                            @if ($potatoData->in_cluster == 1)
                                                                <option value="1" selected>ভিতরে</option>
                                                                <option value="2">বাইরে</option>
                                                            @elseif ($potatoData->in_cluster == 2)
                                                                <option value="1">ভিতরে</option>
                                                                <option value="2" selected>বাইরে</option>
                                                            @else
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="crop_cutting_date"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>তথ্য
                                                                সংগ্রহের তারিখ: </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="date"
                                                            placeholder="Enter Crop Cutting Date" name="crop_cutting_date"
                                                            value="{{ $potatoData->crop_cutting_date }}"
                                                            id="crop_cutting_date" required />
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="potato_varieties"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>আলুর জাত:
                                                            </b><span class="text-danger">*</span></label>

                                                        <select class="select2 form-control" id="potato_varieties"
                                                            name="potato_varieties" required>
                                                            ...
                                                            @elseif ($potatoData->potato_varieties == 2)
                                                                ...
                                                                <option value="2" selected>উচ্চ ফলনশীল</option>
                                                                <option value="3">ইন্ডিয়ান</option>
                                                            @elseif ($potatoData->potato_varieties == 2)
                                                                <option value="1">দেশি</option>
                                                                <option value="2">উচ্চ ফলনশীল</option>
                                                                <option value="3" selected>ইন্ডিয়ান</option>
                                                            @else
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="number_of_row"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>ভূমি খন্ডের
                                                                মোট সারির সংখ্যা: </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder=""
                                                            name="number_of_row"
                                                            value="{{ $potatoData->number_of_row }}" id="number_of_row"
                                                            required />

                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="location_of_sample_row_1"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>১ম নমুনা
                                                                সারির অবস্থান (তম): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="তম"
                                                            name="location_of_sample_row_1" id="location_of_sample_row_1"
                                                            value="{{ $potatoData->location_of_sample_row_1 }}"
                                                            required />

                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="row_length_feet_1"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>১ম নমুনা
                                                                সারির দৈর্ঘ (ফুট): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="ফুট"
                                                            name="row_length_feet_1"
                                                            value="{{ $potatoData->row_length_feet_1 }}"
                                                            id="row_length_feet_1" required />

                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="row_average_width_feet_1"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>১ম নমুনা
                                                                সারির গড় প্রস্থ (ফুট): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="ফুট"
                                                            name="row_average_width_feet_1" id="row_average_width_feet_1"
                                                            value="{{ $potatoData->row_average_width_feet_1 }}"
                                                            required />
                                                ...
                                                <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="land_amount_of_plot"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>ভূমি খন্ডের
                                                                জমির পরিমাণ (একর): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="একর"
                                                            name="land_amount_of_plot"
                                                            value="{{ $potatoData->land_amount_of_plot }}"
                                                            id="land_amount_of_plot" required />

                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="location_of_sample_row_2"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>২ম নমুনা
                                                                সারির অবস্থান (তম): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="তম"
                                                            name="location_of_sample_row_2" id="location_of_sample_row_2"
                                                            value="{{ $potatoData->location_of_sample_row_2 }}" />

                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="row_length_feet_2"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>২ম নমুনা
                                                                সারির দৈর্ঘ (ফুট): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="ফুট"
                                                            name="row_length_feet_2"
                                                            value="{{ $potatoData->row_length_feet_2 }}"
                                                            id="row_length_feet_2" />

                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="row_average_width_feet_2"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>২ম নমুনা
                                                                সারির গড় প্রস্থ (ফুট): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="ফুট"
                                                            name="row_average_width_feet_2" id="row_average_width_feet_2"
                                                            value="{{ $potatoData->row_average_width_feet_2 }}" />
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="random_land_amount_of_plot"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>জমির পরিমাণ
                                                                (একরে): </b><span class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="একরে"
                                                            name="random_land_amount_of_plot"
                                                            id="random_land_amount_of_plot"
                                                            value="{{ $potatoData->random_land_amount_of_plot }}" />

                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="random_location_east_to_west"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>কর্তনকৃত
                                                                জমির অবস্থান পূর্ব থেকে পশ্চিম (ফুট): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="ফুট"
                                                            name="random_location_east_to_west"
                                                            value="{{ $potatoData->random_location_east_to_west }}"
                                                            id="random_location_east_to_west" />

                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="random_number_row_cut"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>কর্তনকৃত
                                                                সারির মোট সংখ্যা: </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder=""
                                                            name="random_number_row_cut"
                                                            value="{{ $potatoData->random_number_row_cut }}"
                                                            id="random_number_row_cut" />

                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="random_row_length_feet"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>কর্তনকৃত
                                                                সারির মোট দৈর্ঘ্য (ফুট): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="ফুট"
                                                            name="random_row_length_feet"
                                                            value="{{ $potatoData->random_row_length_feet }}"
                                                            id="random_row_length_feet" />
                                                ...
                                                <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="random_number_of_row"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>মোট সারির
                                                                সংখ্যা: </b><span class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder=""
                                                            name="random_number_of_row"
                                                            value="{{ $potatoData->random_number_of_row }}"
                                                            id="random_number_of_row" />

                                                    </div>


                                                    <div class="form-group row">
                                                        <label for="random_location_north_to_south"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>কর্তনকৃত
                                                                জমির অবস্থান উত্তর থেকে দক্ষিণ (ফুট): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="ফুট"
                                                            name="random_location_north_to_south"
                                                            id="random_location_north_to_south"
                                                            value="{{ $potatoData->random_location_north_to_south }}" />

                                                    </div>


                                                    <div class="form-group row">
                                                        <label for="random_row_average_width_feet"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>কর্তনকৃত
                                                                সারির গড় প্রস্থ (ফুট): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="ফুট"
                                                            name="random_row_average_width_feet"
                                                            id="random_row_average_width_feet"
                                                            value="{{ $potatoData->random_row_average_width_feet }}" />
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="production_per_acre"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>একর প্রতি
                                                                আলু ফলন (মণ): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="text" placeholder="মণ"
                                                            value="{{ $potatoData->production_per_acre }}"
                                                            name="production_per_acre" id="production_per_acre"
                                                            required />

                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="production_cost_per_acre"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>একর প্রতি
                                                                আলুর উৎপাদন খরচ: </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="text" placeholder=""
                                                            name="production_cost_per_acre"
                                                            value="{{ $potatoData->production_cost_per_acre }}"
                                                            id="production_cost_per_acre" required />

                                                    </div>

                                                    <div class="form-group row">
                                                        <label for="amount_of_cut_potato_kg"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>আলুর ফসল
                                                                কর্তন থেকে প্রাপ্ত আলুর পরিমাণ (কেজি): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="কেজি"
                                                            name="amount_of_cut_potato_kg"
                                                            value="{{ $potatoData->amount_of_cut_potato_kg }}"
                                                            id="amount_of_cut_potato_kg" required />
                                                ...
                                                <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="size_of_cut_row_squre_feet"
                                                            style="font-size: 1.5em; font-weight: bold;"><b>কর্তনকৃত
                                                                সারির আয়তন (বর্গ ফুট): </b><span
                                                                class="text-danger">*</span></label>

                                                        <input class="form-control" type="number" placeholder="বর্গ ফুট"
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <table class="table table-responsive">
                                                <thead>
                                                    <th><label for="farmer_int_id_1"
                                                            style="font-size: 1.1em; font-weight: bold;"><b>চাষির
                                                                নাম:</b> <span class="text-danger">*</span></label></th>
                                                    <th><label for="fathers_name_1"
                                                            style="font-size: 1.1em; font-weight: bold;"><b>পিতার
                                                                নাম: </b><span class="text-danger">*</span></label></th>
                                                    <th><label for="last_year_land_amount_1"
                                                            style="font-size: 1.1em; font-weight: bold;"><b>পূর্ববর্তী
                                                                বছরে মাঠের আয়তন (একর): </b><span
                                                                class="text-danger">*</span></label></th>
                                                    <th><label for="current_year_land_amount_1"
                                                            style="font-size: 1.1em; font-weight: bold;"><b>চলতি
                                                                বছরে মাঠের আয়তন (একর): </b><span
                                                                class="text-danger">*</span></label></th>
                                                    <th><label for="last_year_land_producttion_1"
                                                            style="font-size: 1.1em; font-weight: bold;"><b>পূর্ববর্তী
                                                                বছরে মাঠের উৎপাদন (মণ): </b><span
                                                                class="text-danger">*</span></label></th>
                                                    <th><label for="current_year_land_producttion_1"
                                                            style="font-size: 1.1em; font-weight: bold;"><b>চলতি
                                                                বছরে মাঠের উৎপাদন (মণ): </b><span
                                                                class="text-danger">*</span></label></th>
                                                    <th><label for="comments_1"
                                                            style="font-size: 1.1em; font-weight: bold;"><b>একর
                                                                প্রতি গড় ফলন (কেজি): </b><span
                                                                class="text-danger">*</span></label></th>
                                                </thead>
                                                <tbody id="">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="text-center"
                                                    style="background-color: #134f1f; padding: 10px;">
                                                    <h3 style="color:#ffffff;">নির্বাচিত মাঠের আশেপাশে উক্ত জাতের ফসল
                                                        চাষ করেছে এমন চাষীদের সাক্ষাৎকার</h3>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <table class="table table-responsive" id="tbl_posts">
                                                        <thead>
                                                            ...
                                                            <th><label for="last_year_land_amount_1"
                                                                    style="font-size: 1.1em; font-weight: bold;"><b>পূর্ববর্তী
                                                                        বছরে মাঠের আয়তন (একর): </b></label></th>
                                                            <th><label for="current_year_land_amount_1"
                                                                    style="font-size: 1.1em; font-weight: bold;"><b>চলতি
                                                                        বছরে মাঠের আয়তন (একর): </b></label></th>
                                                            <th><label for="last_year_land_producttion_1"
                                                                    style="font-size: 1.1em; font-weight: bold;"><b>পূর্ববর্তী
                                                                        বছরে মাঠের উৎপাদন (মণ): </b></label></th>
                                                            <th><label for="current_year_land_producttion_1"
                                                                    style="font-size: 1.1em; font-weight: bold;"><b>চলতি
                                                                        বছরে মাঠের উৎপাদন (মণ): </b></label></th>
                                                            <th><label for="comments_1"
                                                                    style="font-size: 1.1em; font-weight: bold;"><b>একর
                                                                        প্রতি গড় ফলন (কেজি): </b></label></th>
                                                        </thead>
                                                            ...
                                                            <tr id="rec-1">
                                                                <td>
                                                                    <div class="text-left">
                                                                        ...
                                                                        <select name="farmer_int_id[]"
                                                                            id="farmer_int_id_1"
                                                                            class="form-control farmer_int_id_1 select_1">
                                                                            <option value="">--চাষির নাম নির্বাচন
                                                                                করুন--
                                                                            </option>
                                                                ...
                                                                <td>
                                                                    <div class="text-left">
                                                                        ...
                                                                        <input class="form-control" type="text"
                                                                            placeholder="" name="farmers_father_name[]"
                                                                            id="fathers_name_1" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="text-left">
                                                                        ...
                                                                        <input class="form-control" type="number"
                                                                            placeholder="" name="last_year_land_amount[]"
                                                                            id="last_year_land_amount_1" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="text-left">
                                                                ...
                                                                <td>
                                                                    <div class="text-left">
                                                                        ...
                                                                        <input class="form-control" type="number"
                                                                            placeholder=""
                                                                            name="last_year_potato_producttion[]"
                                                                ...
                                                                <td>
                                                                    <div class="text-left">
                                                                        ...
                                                                        <input class="form-control" type="number"
                                                                            placeholder=""
                                                                            name="current_year_potato_producttion[]"
                                                                ...
                                                                <td>
                                                                    <div class="text-left">
                                                                        ...
                                                                        <input class="form-control" type="text"
                                                                            placeholder="" name="average_yield_per_acre[]"
                                                                            id="comments_1" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="input-group-btn text-left ml-2">
                                                                        <button class="btn btn-sm btn-success add-record"
                                                                            type="button"
                                    ...
                                    <tr id="">
                                        ...
                                        <td>
                                            <div class="text-left">
                                                ...
                                                <input class="form-control" type="text" placeholder=""
                                                    name="farmers_father_name[]" id="fathers_name" required />
                                            </div>
                                        </td>
                                        <td>
                                            <div class="text-left">
                                                ...
                                                <input class="form-control" type="text" placeholder=""
                                                    name="last_year_land_amount[]" id="last_year_land_amount" required />
                                            </div>
                                        </td>
                                        <td>
                                            <div class="text-left">
                                                ...
                                                <input class="form-control" type="text" placeholder=""
                                                    name="current_year_land_amount[]" id="current_year_land_amount"
                                                    required />
                                            </div>
                                        </td>
                                        <td>
                                            <div class="text-left">
                                                ...
                                                <input class="form-control" type="text" placeholder=""
                                                    name="last_year_potato_producttion[]" id="last_year_land_producttion"
                                                    required />
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="text-left">
                                                ...
                                                <input class="form-control" type="text" placeholder=""
                                                    name="average_yield_per_acre[]" id="comments" required />
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group-btn text-left ml-2">
                                                <button class="btn btn-sm btn-danger delete-record" type="button"
                                                    data-id="0" style="padding: 0.75rem;width: 100px;">মুছে
                                                    ফেলুন</button>
                                            </div>
                                        </td>
                                    </tr>
...
@push('stackScript')
    ...
    <script>
        $('#previousAverage').on('keyup', function() {
