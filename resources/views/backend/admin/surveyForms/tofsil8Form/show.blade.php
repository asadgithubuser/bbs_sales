                                                ...
                                                <div class="row">
                                                    <div class="col-md-6"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <input disabled style="display:{{ $tofsil8Data->farmers_name ? '' : 'none'}} ;" class="form-control mt-3"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <input class="form-control" disabled type="number" placeholder="টাকায়"
                                                    ...
                                                    <div class="col-md-6"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <input class="form-control" type="number" placeholder=""
                                                                step="0.01" id="two_meal_female" disabled
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <input class="form-control" type="number" disabled placeholder="টাকায়"
