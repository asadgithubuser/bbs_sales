                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom example example-compact">
                            <div class="card card-custom gutter-b example example-compact">
                                ...
                                <!--begin::Form-->
                                <form action="{{ route('admin.surveyTofsilForm8.store') }}" method="post">
                                    @csrf
                                    ...
                                    @if (!empty($processList))
                                        ...
                                        <input type="hidden" name="cluster_id" value="{{ $processList->bunch_stains_id }}" />
                                    @endif
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <input style="display:none;" class="form-control mt-3" type="text" placeholder="চাষীর নাম" id="farmers_name" name="farmers_name" />

                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label for="fathers_name" style="font-size: 1.2em; font-weight: bold;"><b>পিতার নাম: </b><span class="text-danger">*</span></label>
                                                          
                                                                        <input class="form-control" type="text" placeholder="" id="fathers_name" name="fathers_name" required/>
                                                                       
                                                                    </div>
                                                                    

                                                                    <div class="form-group row">
                                                                        <label for="one_meal_male" style="font-size: 1.2em; font-weight: bold;"><b>এক বেলা খোরাকিসহ  মজুরির পরিমান (পুরুষ): </b></label>
                                                                    
                                                                                    <input class="form-control" type="number" placeholder="টাকায়" step="0.01" id="one_meal_male" name="one_meal_male"/>
                                                                        
                                                                    </div>


                                                                    <div class="form-group row">
                                                                        <label for="two_meal_male" style="font-size: 1.2em; font-weight: bold;"><b>দুই বেলা খোরাকিসহ  মজুরির পরিমান (পুরুষ): </b></label>
                                                                     
                                                                                    <input class="form-control" type="number" placeholder="টাকায়" step="0.01" id="two_meal_male" name="two_meal_male"/>
                                                                       
                                                                    </div>
                                                          

                                                                    <div class="form-group row">
                                                                        <label for="three_meal_male" style="font-size: 1.2em; font-weight: bold;"><b>তিন বেলা খোরাকিসহ  মজুরির পরিমান (পুরুষ): </b></label>
                                                                   
                                                                                    <input class="form-control" type="number" placeholder="টাকায়" step="0.01" id="three_meal_male" name="three_meal_male"/>
                                                                      
                                                                    </div>
                                          
                                                                    <div class="form-group row">
                                                                        <label for="without_meal_male" style="font-size: 1.2em; font-weight: bold;"><b>বিনা খোরাকিতে  মজুরির পরিমান (পুরুষ): </b></label>
                                                                      
                                                                                    <input class="form-control" type="number" placeholder="টাকায়" step="0.01" id="without_meal_male" name="without_meal_male"/>
                                                        ...
                                                        <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="farmers_mobile" style="font-size: 1.2em; font-weight: bold;"><b>চাষীর মোবাইল নম্বর: </b><span class="text-danger">*</span></label>
                                                                                <input class="form-control" type="text" placeholder="" id="farmers_mobile" name="farmers_mobile" required/>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="one_meal_female" style="font-size: 1.2em; font-weight: bold;"><b>এক বেলা খোরাকিসহ  মজুরির পরিমান (নারী): </b></label>
                                                      
                                                                                <input class="form-control" type="number" placeholder="টাকায়" step="0.01" id="one_meal_female" name="one_meal_female"/>
                                                                  
                                                                </div>

                                                                <div class="form-group row">
                                                                    <label for="two_meal_female" style="font-size: 1.2em; font-weight: bold;"><b>দুই বেলা খোরাকিসহ  মজুরির পরিমান (নারী): </b></label>
                                                                    
                                                                                <input class="form-control" type="number" placeholder="" step="0.01" id="two_meal_female" name="two_meal_female"/>
                                                                     
                                                                </div>

                                                           
                                                                <div class="form-group row">
                                                                    <label for="three_meal_female" style="font-size: 1.2em; font-weight: bold;"><b>তিন বেলা খোরাকিসহ  মজুরির পরিমান (নারী): </b></label>
                                                                
                                                                                <input class="form-control" type="number" placeholder="টাকায়" step="0.01" id="three_meal_female" name="three_meal_female"/>
                                                                     
                                                                </div>

                                                          
                                                                <div class="form-group row">
                                                                    <label for="without_meal_female" style="font-size: 1.2em; font-weight: bold;"><b>বিনা খোরাকিতে  মজুরির পরিমান (নারী): </b></label>
                                                   
                                                                                <input class="form-control" type="number" placeholder="টাকায়" step="0.01" id="without_meal_female" name="without_meal_female"/>
