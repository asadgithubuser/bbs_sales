                                                    ...
                                                    <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                            ...
                                                            <label for="crop_id" style="font-size: 1.2em; font-weight: bold;"><b>ফসলের নাম: </b><span class="text-danger">*</span></label>
                                                                    ...
                                                                    @if (isset($surveyNotification))
                                                                        @if ($surveyNotification->crop_id != '')
                                                                            ...
                                                                            <input type="text" disabled class="form-control" value="{{ $surveyNotification->crop ? ucfirst($surveyNotification->crop->name_en) : '' }}" >
                                                                        @else
                                                                            <select class=" form-control" id="crops_id" name="crops_id" required>
                                                                        ...
                                                                        @endif
                                                                    @else
                                                                        <select class=" form-control" id="crops_id" disabled name="crops_id" required>
                                                                            <option value="">--ফসলের নাম নির্বাচন করুন--</option>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="loss_period_start_date" style="font-size: 1.2em; font-weight: bold;"><b>ক্ষয়ক্ষতির শুরুর তারিখ: </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control" disabled type="date" value="{{ $surveyTofsilForm11->loss_period_start_date }}" name="loss_period_start_date" id="loss_period_start_date" required/>
                                                    ...
                                                    <div class="col-md-6" style="padding-left: 35px; padding-right:35px;"> 
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="cause_of_loss" style="font-size: 1.2em; font-weight: bold;"><b>ক্ষয়ক্ষতির প্রধান কারণ: </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control" disabled type="text" value="{{ $surveyTofsilForm11->cause_of_loss }}" name="cause_of_loss" id="cause_of_loss" required/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="loss_period_end_date" style="font-size: 1.2em; font-weight: bold;"><b>ক্ষয়ক্ষতির শেষ হওয়ার তারিখ: </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control" disabled type="date" value="{{ $surveyTofsilForm11->loss_period_end_date }}" name="loss_period_end_date" id="loss_period_end_date" required/>
                                                    ...
                                                    <div class="col-md-6" style="padding-left: 35px; padding-right:35px;">
                                                                <div class="form-group row">
                                                                    <label for="land_amound" style="font-size: 1.2em; font-weight: bold;"><b>ফসলের আওতাদিন জমির পরিমাণ (একরে): </b><span class="text-danger">*</span></label>
                                                                        ...
                                                                        <input class="form-control" disabled value="{{ $surveyTofsilForm11->land_amound }}" type="number" step="0.01" placeholder="একরে" name="land_amound" id="land_amound" required/>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="partial_damage" style="font-size: 1.2em; font-weight: bold;"><b>আংশিক ক্ষতি (একরে): </b><span class="text-danger">*</span></label>
                                                                        ...
                                                                        <input class="form-control" disabled value="{{ $surveyTofsilForm11->partial_damage }}" type="number" step="0.01" placeholder="একরে" name="partial_damage" id="partial_damage" required/>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="complete_damage" style="font-size: 1.2em; font-weight: bold;"><b>সম্পূর্ণ  ক্ষতি: </b><span class="text-danger">*</span></label>
                                                                        ...
                                                                        <input class="form-control" disabled type="number" value="{{ $surveyTofsilForm11->complete_damage }}" step="0.01" placeholder="" name="complete_damage" id="complete_damage" required/>
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="percentage_of_damage" style="font-size: 1.2em; font-weight: bold;"><b>ক্ষতির শতকরা হার: </b><span class="text-danger">*</span></label>
                                                                        ...
                                                                        <input class="form-control" disabled type="number" step="0.01" placeholder="" name="percentage_of_damage" value="{{ $surveyTofsilForm11->percentage_of_damage }}" id="percentage_of_damage" required/>
                                                    ...
                                                    <div class="col-md-6" style="padding-left: 35px; padding-right:35px;"> 
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="yield_per_desired_acre" style="font-size: 1.2em; font-weight: bold;"><b>কাঙ্খিত একর প্রতি ফলন (কেজি): </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control" disabled value="{{ $surveyTofsilForm11->yield_per_desired_acre }}" type="number" step="0.01" placeholder="কেজি" name="yield_per_desired_acre" id="yield_per_desired_acre" required/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="partial_damage_to_total_damage" style="font-size: 1.2em; font-weight: bold;"><b>আংশিক ক্ষতিতে সম্পূর্ণ ক্ষতির পরিমাণ (একরে): </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control" disabled value="{{ $surveyTofsilForm11->partial_damage_to_total_damage }}" type="number" step="0.01" placeholder="একরে" name="partial_damage_to_total_damage" id="partial_damage_to_total_damage" required/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="estimated_amount_of_crop_loss" style="font-size: 1.2em; font-weight: bold;"><b>প্রাক্কলিত ফসলের ক্ষতির পরিমাণ (মে. টন): </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control" disabled value="{{ $surveyTofsilForm11->estimated_amount_of_crop_loss }}" type="number" step="0.01" placeholder="মে. টন" name="estimated_amount_of_crop_loss" id="estimated_amount_of_crop_loss" required/>
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="amount_of_crop_loss_tk" style="font-size: 1.2em; font-weight: bold;"><b>ফসলের মোট ক্ষতির পরিমাণ (টাকায়): </b><span class="text-danger">*</span></label>
                                                                ...
                                                                <input class="form-control" value="{{ $surveyTofsilForm11->amount_of_crop_loss_tk }}" disabled type="number" step="0.01" placeholder="টাকায়" name="amount_of_crop_loss_tk" id="amount_of_crop_loss_tk" required/>
