                            ...
                            <form class="form" action="{{ route('admin.storage.store') }}" method="post" id="kt_form_1" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-5 col-sm-12">
                                            <input type="text" class="form-control {{ $errors->has('subtitle') ? ' is-invalid' : '' }}" name="subtitle" placeholder="Enter Subtitle" value="{{old('subtitle')}}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label text-right col-lg-4 col-sm-12">Survey / Census Date: <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-5 col-sm-12">
                                            <input type="date" class="form-control {{ $errors->has('survey_date') ? ' is-invalid' : '' }}" name="survey_date"  value="{{old('survey_date')}}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-5 col-sm-12">
                                            <input type="date" class="form-control {{ $errors->has('publish_date') ? ' is-invalid' : '' }}" name="publish_date" placeholder="Enter Data source" value="{{old('publish_date')}}" required>
                                        </div>
                                    </div>
