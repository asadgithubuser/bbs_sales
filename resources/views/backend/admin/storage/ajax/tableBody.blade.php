                ...
                <td>
                    ...
                    <div class="btn-group btn-group-xs" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                       <div class="dropdown-menu p-3 show" aria-labelledby="btnGroupDrop1" x-placement="top-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-100px, -103px, 0px);"> 
                          <a data-toggle="modal" data-target="#exampleModal{{ $item->id }}" class="dropdown-item btn btn-sm mt-1 ml-0 mb-1 mr-2 btn-info">View</a>

                          <a href="{{ route('admin.storage.edit',$item) }}" class="dropdown-item  btn btn-sm mt-1 ml-0 mb-1 mr-2 btn-warning" >Edit</a>

                          <a data-toggle="modal" data-target="#quantityAdd{{ $item->id }}" class="dropdown-item btn btn-sm mt-1 ml-0 mb-1 mr-2 btn-primary" >Add Quantity</a>

                          @if ($item->status == 1)
                            <a class="dropdown-item delete btn btn-sm mt-1 ml-0 mb-1 mr-2 btn-danger" data-id="{{ $item->id }}">Delete</a>

                          @elseif ($item->status == 0)
                            <a class="dropdown-item delete btn btn-sm mt-1 ml-0 mb-1 mr-2 btn-success" data-id="{{ $item->id }}">Active</a>

                          
                          @endif
                            <a class="dropdown-item btn btn-sm mt-1 ml-0 mb-1 mr-2 w3-gray text-white" href="{{ route('admin.storage.barcode', $item->id) }}">Barcode</a>
