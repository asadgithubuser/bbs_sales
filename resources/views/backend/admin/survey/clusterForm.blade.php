                        ...
                        <div class="card card-custom m-9">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="4">বিভাগ: {{$list->division ? $list->division->name_en : ''}}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="4">জেলা: {{$list->district ? $list->district->name_en : ''}}</td>
                                            {{-- <td style="border: 1px solid #000" align="left" colspan="2">উপজেলা/থানা: {{$list->upazila ? $list->upazila->name_en : ''}}</td> --}}
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="4">কোড: {{$list->division ? $list->division->division_bbs_code : ''}}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="4">কোড: {{$list->district ? $list->district->district_bbs_code : ''}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left">
                                                @foreach ($clusters->groupBy('bunch_stains_id')->get() as $item)
                                                    @if ($data = $item->cluster)
                                                    
                                                        @foreach(explode(",",$data->union_id) as $union)
                                                            
                                                            @php
                                                                $value = $item->union($union)    
                                                            @endphp
                                                            {{ $value->name_bn }}
                                                            @if ($loop->last)
                                                            @else
                                            ...
                                            <td style="border: 1px solid #000" align="left">
                                                @foreach ($clusters->groupBy('bunch_stains_id')->get() as $item)
                                                    @if ($data = $item->cluster)
                                                        ...
                                                        @foreach(explode(",",$data->mouza_id) as $mouza)
                                                            
                                                            @php
                                                                $value = $item->mouza($mouza)    
                                                            @endphp
                                                            {{ $value->name_bn }}
                                                            @if ($loop->last)
                                                            @else
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left" colspan="2">{{$list->cluster ? $list->cluster->code : ''}}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="2">জে,এল,নং:</td>
                                            <td style="border: 1px solid #000" align="left" colspan="2">
                                                @foreach(explode(",",$data->mouza_id) as $mouza)
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach ($totalclusters as $cluster)
                                            <tr>
                                                ...
                                                <td style="border: 1px solid #000" align="left">
                                                    {{$cluster->farmer ? $cluster->farmer->farmers_name : ''}} <br>
                                                    {{$cluster->farmers_mobile}}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
