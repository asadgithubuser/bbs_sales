                                ...
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach ($temporaryCrops as $temporaryCrop)
                                            ...
                                            @endphp
                                            <tr>
                                                <td style="border: 1px solid #000" align="left" rowspan="{{ $data + 1 }}">  {{ $temporaryCrop->district ? $temporaryCrop->district->name_bn : '' }}</td>
                                                
                                                <td style="border: 1px solid #000" align="left"> 
                                                    {{ $temporaryCrop->allDataOfDistrict($temporaryCrop->survey_notification_id,$temporaryCrop->district_id,'last_year_land_amount') }}
                                                     
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $temporaryCrop->allDataOfDistrict($temporaryCrop->survey_notification_id,$temporaryCrop->district_id,'current_year_land_amount') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $temporaryCrop->allDataOfDistrict($temporaryCrop->survey_notification_id,$temporaryCrop->district_id,'last_year_land_producttion') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                    {{ $temporaryCrop->allDataOfDistrict($temporaryCrop->survey_notification_id,$temporaryCrop->district_id,'current_year_land_producttion') }}     
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                    {{-- {{ number_format((float)$item->acre_reflection_rate, 4, '.', '' ) }} --}}
                                                    {{ $temporaryCrop->allDataOfDistrict($temporaryCrop->survey_notification_id,$temporaryCrop->district_id,'acre_reflection_rate') }} 
                                                </td>
