                        ...
                        <div class="card card-custom m-9">
                            <div class="card-header mt-5">
                                ...
                                <div class="col-lg-6 offset-lg-3 text-center mt-4" style="line-height: 100%">
                                    ...
                                    <p class="font-weight-bold mt-4">Estimate of Wheat, 2019-20</p>
                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td style="border: 1px solid #000; font-size: 1.1em;" align="middle">01</td>
                                            <td style="border: 1px solid #000; font-size: 1.1em;" align="Left">Mymensingh</td>
                                            <td style="border: 1px solid #000; font-size: 1.1em;" align="Left">Mymensingh</td>
