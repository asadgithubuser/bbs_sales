                                ...
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left" colspan="2">ইউনিয়ন/ওয়ার্ড:</td>
                                            <td style="border: 1px solid #000" align="left">মৌজা:</td>
                                            <td style="border: 1px solid #000" align="left" colspan="2" rowspan="2">তথ্য সংগ্রহের তারিখ</td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="2">কোড:</td>
                                            <td style="border: 1px solid #000" align="left" colspan="2">কোড:</td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" rowspan="8">১</td>
                                        </tr>
                                        {{-- data loop statrt --}}
                                        <tr>
