                        ...
                        <div class="card card-custom m-9">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="11">বিভাগ: {{$list->division ? $list->division->name_en : ''}}</td>
                                        ...
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="11">কোড:{{$list->division ? $list->division->division_bbs_code : ''}}</td>
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" rowspan="3">জেলা</td>
                                        ...
                                        @php
                                            $data = 0;
                                            foreach ($cluster->districtData($cluster->district_id) as $key) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left" rowspan="{{ $data + 1}}">{{ $cluster->district ?  $cluster->district->name_en : '' }}</td>
                                            @foreach ($cluster->districtData($cluster->district_id) as $item)
                                                <tr>
