                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        ...
                                        @php
                                            $data = 0;
                                            foreach ($crop->upazilaData($crop->upazila_id) as $key) {
                                        ...
                                        @endphp
                                            <tr>
                                                ...
                                                <td style="border: 1px solid #000" align="left" rowspan="{{ $data + 1 }}"> {{ $crop->upazila ? $crop->upazila->name_bd : '' }}</td>

                                                <td style="border: 1px solid #000" align="left">
                                                    {{ $crop->allDataOfUpazila($crop->survey_notification_id,$crop->upazila_id,'total_trees') }}
                                                     
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfUpazila($crop->survey_notification_id,$crop->upazila_id,'total_fruity_trees_in_garden') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfUpazila($crop->survey_notification_id,$crop->upazila_id,'total_fruity_scattered_trees') }}

                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfUpazila($crop->survey_notification_id,$crop->upazila_id,'total_fruity_trees') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfUpazila($crop->survey_notification_id,$crop->upazila_id,'land_amount_under_the_fruitly_trees') }}
                                                </td>

                                                <td style="border: 1px solid #000" align="left">
                                                    
                                                    {{ $crop->allDataOfUpazila($crop->survey_notification_id,$crop->upazila_id,'average_yield_per_tree') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfUpazila($crop->survey_notification_id,$crop->upazila_id,'total_production') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                    {{ $crop->allDataOfUpazila($crop->survey_notification_id,$crop->upazila_id,'total_fruitless_trees') }}
                                                </td>

                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfUpazila($crop->survey_notification_id,$crop->upazila_id,'land_amount_under_the_fruitless_trees') }}

                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                    {{ $crop->allDataOfUpazila($crop->survey_notification_id,$crop->upazila_id,'land_amount_under_the_fruitly_trees') + $crop->allDataOfUpazila($crop->survey_notification_id,$crop->upazila_id,'land_amount_under_the_fruitless_trees')}}
                                                    
                                                </td>
                                            
                                                @foreach ($crop->upazilaData($crop->upazila_id) as $item)
                                                    
                                                    {{-- <tr>
                                                        
                                                        <td style="border: 1px solid #000" align="left">{{ $item->total_trees }}</td>
