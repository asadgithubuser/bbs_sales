                                        ...
                                        @endphp
                                            <tr>
                                                ...
                                                @foreach ($crop->upazilaData($crop->upazila_id) as $item)
                                                    ...
                                                    <tr>
                                                        {{-- <td style="border: 1px solid #000" align="left">ইউনিয়নঃ {{ $item->union ? $item->union->name_bn :''}}, উপজেলাঃ {{ $item->upazila ? $item->upazila->name_bd :''}}, <br>
                                                            জেলাঃ {{ $item->district ? $item->district->name_bn :'' }}</td> --}}
