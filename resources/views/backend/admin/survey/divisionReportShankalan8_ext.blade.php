                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table" style="margin-bottom: 25px">
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="4">বিভাগের নাম:{{ $list->division ? $list->division->name_bn :'' }}</td>
                                            {{-- <td style="border: 1px solid #000" align="left" colspan="2">জেলার নাম:{{ $list->district ? $list->district->name_bn :'' }}</td> --}}
                                            <td style="border: 1px solid #000" align="left" colspan="2">মাস (ইংরেজিতে)</td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left" colspan="4">{{ $list->created_at->format('F') }}</td>
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="center" rowspan="3">জেলা</td>
                                        ...
                                        @foreach ($divisionDatas as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: 1px solid #000" align="center">{{ $data->district ? $data->getDivisionData($data->division_id,'one_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDivisionData($data->division_id,'one_meal_female') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDivisionData($data->division_id,'two_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDivisionData($data->division_id,'two_meal_female') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDivisionData($data->division_id,'three_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDivisionData($data->division_id,'three_meal_female') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDivisionData($data->division_id,'without_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDivisionData($data->division_id,'without_meal_female') :'' }}</td>
                                            </tr>
                                            @php
                                                $total_one_meal_male += $data->upazila ? $data->getDivisionData($data->division_id,'one_meal_male') :'' ;
                                                $total_one_meal_female += $data->upazila ? $data->getDivisionData($data->division_id,'one_meal_female') :'' ;
                                                $total_two_meal_male += $data->upazila ? $data->getDivisionData($data->division_id,'two_meal_male') :'';
                                                $total_two_meal_female += $data->upazila ? $data->getDivisionData($data->division_id,'two_meal_female') :'';
                                                $total_three_meal_male += $data->upazila ? $data->getDivisionData($data->division_id,'two_meal_female') :'';
                                                $total_three_meal_female += $data->upazila ? $data->getDivisionData($data->division_id,'three_meal_male') :'';
                                                $total_without_meal_male +=  $data->upazila ? $data->getDivisionData($data->division_id,'without_meal_male') :'';
                                                $total_without_meal_female += $data->upazila ? $data->getDivisionData($data->division_id,'without_meal_female') :'';
                                            @endphp
                                        @endforeach
                                        {{-- End loop --}}
