                                ...
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left" colspan="3">জেলা: <b>{{ $list->district ? $list->district->name_bn : '' }}</b></td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left">কোড: </td>
                                            <td style="border: 1px solid #000" align="left" colspan="2"><b>{{ $list->district ? $list->district->district_bbs_code : '' }}</b></td>
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left" rowspan="2">ইউনিয়ন/উপজেলা</td>
                                        ...
                                        <tr>
                                            <td style="border: 1px solid #000" align="left">গত বছর </td>
                                            <td style="border: 1px solid #000" align="left">চলতি বছর </td>
                                            <td style="border: 1px solid #000" align="left">গত বছর </td>
                                            <td style="border: 1px solid #000" align="left">চলতি বছর </td>
                                        </tr>
                                        <tr>
                                        ...
                                        @foreach ($temporaryCrops as $temporaryCrop)
                                            @php
                                                $data = 0;
                                                foreach($temporaryCrop->upazilaCrops($temporaryCrop->upzila_id) as $key){
                                                    $data = $data ;

                                                }
                                            @endphp
                                            <tr>
                                                <td style="border: 1px solid #000" align="left" rowspan="{{ $data + 1 }}">{{ $loop->index + 1}}.  {{ $temporaryCrop->upazila ? $temporaryCrop->upazila->name_bd : '' }}</td>
                                                <td style="border: 1px solid #000" align="left">{{ $temporaryCrop->allDataOfUpazila($temporaryCrop->survey_notification_id,$temporaryCrop->upazila_id,'last_year_land_amount') }}  </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $temporaryCrop->allDataOfUpazila($temporaryCrop->survey_notification_id,$temporaryCrop->upazila_id,'current_year_land_amount') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                    {{ $temporaryCrop->allDataOfUpazila($temporaryCrop->survey_notification_id,$temporaryCrop->upazila_id,'last_year_land_producttion') }}
                                                     
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                    {{ $temporaryCrop->allDataOfUpazila($temporaryCrop->survey_notification_id,$temporaryCrop->upazila_id,'current_year_land_producttion') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $temporaryCrop->allDataOfUpazila($temporaryCrop->survey_notification_id,$temporaryCrop->upazila_id,'acre_reflection_rate') }}
                                                </td>
                                                
                                                @foreach ($temporaryCrop->upazilaCrops($temporaryCrop->upazila_id) as $item)
                                                    {{-- <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left">{{ $total_acre_reflection_rate }}</td>
                                        </tr>
                                    </table>
                                </div>
