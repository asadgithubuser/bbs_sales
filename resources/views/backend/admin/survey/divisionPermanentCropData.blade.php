                        ...
                        <div class="card card-custom m-9">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="4">বিভাগ: <b>{{ $list->division ? $list->division->name_bn : '' }}</b></td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="4">কোড: <b>{{ $list->division ? $list->division->division_bbs_code : '' }}</b></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left">১১(=৭+১১)</td>
                                        ...
                                        @php
                                            $data = 0;
                                            foreach ($crop->districtData($crop->district_id) as $key) {

                                                $data = $data ;
                                            }
                                        @endphp
                                            <tr>
                                                <td style="border: 1px solid #000" align="left" rowspan="{{ $data + 1 }}"> {{ $crop->district ? $crop->district->name_bn : '' }}</td>

                                                <td style="border: 1px solid #000" align="left">
                                                    {{ $crop->allDataOfDistrict($crop->survey_notification_id,$crop->district_id,'total_trees') }}
                                                     
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfDistrict($crop->survey_notification_id,$crop->district_id,'total_fruity_trees_in_garden') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfDistrict($crop->survey_notification_id,$crop->district_id,'total_fruity_scattered_trees') }}

                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfDistrict($crop->survey_notification_id,$crop->district_id,'total_fruity_trees') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfDistrict($crop->survey_notification_id,$crop->district_id,'land_amount_under_the_fruitly_trees') }}
                                                </td>

                                                <td style="border: 1px solid #000" align="left">
                                                    
                                                    {{ $crop->allDataOfDistrict($crop->survey_notification_id,$crop->district_id,'average_yield_per_tree') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfDistrict($crop->survey_notification_id,$crop->district_id,'total_production') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                    {{ $crop->allDataOfDistrict($crop->survey_notification_id,$crop->district_id,'total_fruitless_trees') }}
                                                </td>

                                                <td style="border: 1px solid #000" align="left">
                                                     
                                                    {{ $crop->allDataOfDistrict($crop->survey_notification_id,$crop->district_id,'land_amount_under_the_fruitless_trees') }}

                                                </td>
                                                <td style="border: 1px solid #000" align="left">
                                                    {{ $crop->allDataOfDistrict($crop->survey_notification_id,$crop->district_id,'land_amount_under_the_fruitly_trees') + $crop->allDataOfDistrict($crop->survey_notification_id,$crop->district_id,'land_amount_under_the_fruitless_trees')}}
                                                ...
                                                <td style="border: 1px solid #000" align="left">{{ $item->total_fruity_trees }}</td>
                                                <td style="border: 1px solid #000" align="left">{{ $item->land_amount_under_the_fruitly_trees }}</td>
                                                <td style="border: 1px solid #000" align="left">{{ number_format((float)$item->average_yield_per_tree, 4, '.', '') }}</td>
                                                ...
                                                @foreach ($crop->districtData($crop->district_id) as $item)
