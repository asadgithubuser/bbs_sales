                                ...
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table" style="margin-bottom: 25px">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left" colspan="5">{{ $list->division ? $list->division->division_bbs_code : '' }}</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 1px solid #000" align="center" rowspan="2">জেলা</td>
                                        ...
                                        @php
                                            // district total data
                                            $districtTotalLand = 0;
                                            $districtTotalPersialDamage = 0;
                                            $districtTotalDamagePercentage = 0;
                                            $districtTotalPersialToFullDamage = 0;
                                            $districtTotalCompleteDamage = 0;
                                            $districtTotalSummationDamage = 0;
                                            $districtTotalEstimatedYield = 0;
                                            $districtTotalEstimatedCropLoss = 0;
                                        ...
                                        @foreach ($tofsil11datas as $ata)
                                            @foreach ($ata->districtDatas($ata->district_id) as $data)
                                            @php
                                                $districtTotalLand += $data->land_amound;
                                                $districtTotalPersialDamage += $data->partial_damage;
                                                $districtTotalDamagePercentage += $data->percentage_of_damage;
                                                $districtTotalPersialToFullDamage += $data->partial_damage_to_total_damage;
                                                $districtTotalCompleteDamage += $data->complete_damage;
                                                $districtTotalSummationDamage += $data->partial_damage_to_total_damage + $data->complete_damage;
                                                $districtTotalEstimatedYield += $data->yield_per_desired_acre;
                                                $districtTotalEstimatedCropLoss += $data->estimated_amount_of_crop_loss;
                                                $TotalMoneyLoss += $data->amount_of_crop_loss_tk;
                                            @endphp
                                            @endforeach
                                            <tr>
                                                <td style="border: 1px solid #000" align="center">{{ $list->district ? $list->district->name_bn : '' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{$districtTotalLand}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$districtTotalPersialDamage}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$districtTotalDamagePercentage}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$districtTotalPersialToFullDamage}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$districtTotalCompleteDamage}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$districtTotalSummationDamage}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$districtTotalEstimatedYield}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$districtTotalEstimatedCropLoss}}</td>
                                            </tr>
                                            @php
                                                $finalTotalLand += $districtTotalLand;
                                                $finalTotalPersialDamage += $districtTotalPersialDamage;
                                                $finalTotalDamagePercentage += $districtTotalDamagePercentage;
                                                $finalTotalPersialToFullDamage += $districtTotalPersialToFullDamage;
                                                $finalTotalCompleteDamage += $districtTotalCompleteDamage;
                                                $finalTotalSummationDamage += $districtTotalSummationDamage;
                                                $finalTotalEstimatedYield += $districtTotalEstimatedYield;
                                                $finalTotalEstimatedCropLoss += $districtTotalEstimatedCropLoss;
                                            @endphp
                                        @endforeach
                                        {{-- End loop --}}
                                        <tr>
