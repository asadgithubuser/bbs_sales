                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table" style="margin-bottom: 25px">
                                        ...
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="2">ফসলের নাম: {{ $surveyNotification->crop ? $surveyNotification->crop->name_bn : ''}}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="2">ফসলের জাত: {{ $surveyNotification->cropType ? $surveyNotification->cropType->crop_type_bn : '' }}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="3">তথ্য সংগ্রহের তারিখ: {{ $surveyNotification->notification_start_data_field }} হতে {{ $surveyNotification->notification_end_data_field }}</td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        @php
                                            $total_temporary_crop_land_amound = 0;
                                            //previous year deshi
                                            $total_previous_year_land_amound_desi = 0;
                                            // previous year upshi
                                            $total_previous_year_land_amound_upashi = 0;
                                            //current year deshi
                                            $total_current_year_land_amound_desi = 0;
                                            //current year upshi
                                            $total_current_year_land_amound_upashi = 0;
                                        @endphp
                                        {{-- start loop --}}
                                        @foreach ($tofsil10sdata as $data)                                            
                                            <tr>
                                                <td style="border: 1px solid #000" align="center" rowspan="2">{{ $data->index + 1 }}</td>
                                                <td style="border: 1px solid #000" align="center" rowspan="2">{{ $data->upazila ? $data->upazila->name_bd:'' }}</td>
                                                {{-- @foreach ($collection as $item)
                                                    
                                                @endforeach --}}
                                                <td style="border: 1px solid #000" align="center" rowspan="2">{{ $data->temporary_crop_land_amound }}</td>
                                                <td style="border: 1px solid #000" align="center">1</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->previous_year_land_amound_desi }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->current_year_land_amound_desi }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->note_desi }}</td>

                                            </tr>
                                        
                                            <tr>
                                                <td style="border: 1px solid #000" align="center">2</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->previous_year_land_amound_upashi }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->current_year_land_amound_upashi }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->note_upashi }}</td>
                                            </tr>
                                            @php
                                                $total_temporary_crop_land_amound += $data->temporary_crop_land_amound;
                                                $total_previous_year_land_amound_desi += $data->previous_year_land_amound_desi;
                                                $total_previous_year_land_amound_upashi += $data->previous_year_land_amound_upashi;
                                                $total_current_year_land_amound_desi +=$data->current_year_land_amound_desi;
                                                $total_current_year_land_amound_upashi += $data->current_year_land_amound_upashi;
                                            @endphp
                                        @endforeach
                                        {{-- end loop --}}
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="center" rowspan="2">{{ $total_temporary_crop_land_amound }}</td>
                                            <td style="border: 1px solid #000" align="center">1</td>
                                            <td style="border: 1px solid #000" align="center"> {{ $total_previous_year_land_amound_desi }}</td>
                                            <td style="border: 1px solid #000" align="center">{{ $total_current_year_land_amound_desi }}</td>
                                            <td style="border: 1px solid #000" align="center">-</td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="center">2</td>
                                            <td style="border: 1px solid #000" align="center">{{ $total_previous_year_land_amound_upashi }}</td>
                                            <td style="border: 1px solid #000" align="center">{{ $total_current_year_land_amound_upashi }}</td>
                                            <td style="border: 1px solid #000" align="center">-</td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="2">উপজেলায় অবস্থিত</td>
                                            <td style="border: 1px solid #000" align="center">{{ $total_temporary_crop_land_amound }}</td>
                                            <td style="border: 1px solid #000" align="center"></td>
                                            <td style="border: 1px solid #000" align="center">{{  $total_previous_year_land_amound_upashi +
                                                $total_previous_year_land_amound_desi }}</td>
                                            <td style="border: 1px solid #000" align="center">{{ $total_current_year_land_amound_desi
                                               + $total_current_year_land_amound_upashi }}</td>
                                            <td style="border: 1px solid #000" align="center">-</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table class="table">
                                        ...
                                        @php
                                            //previous land amount 
                                            $total_previous_land_amound = 0;
                                            //previous yeild
                                            $total_previous_yield = 0;
                                            //previous_total_production
                                            $total_previous_total_production = 0;
                                            // current_land_amound
                                            $total_current_land_amound = 0;
                                            //current_yield
                                            $total_current_yield = 0;
                                            //current_total_production
                                             $total_current_total_production = 0;
                                        @endphp
                                        @foreach ($tofsil10sdata as $data)
                                        @foreach ($data->cropProductions as $item)
                                            @php
                                                $total_previous_land_amound += $item->previous_land_amound;
                                                $total_previous_yield += $item->previous_yield;
                                                $total_previous_total_production += $item->previous_total_production;
                                                $total_current_land_amound += $item->current_land_amound;
                                                $total_current_yield += $item->current_yield;
                                                $total_current_total_production += $item->current_total_production;
                                                $data = $item->note;
                                            @endphp
                                        @endforeach
                                        @endforeach
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="center">
                                                {{ $surveyNotification->crop ? $surveyNotification->crop->name_bn : ''}} <br>
                                                ({{ $surveyNotification->cropType ? $surveyNotification->cropType->crop_type_bn : '' }})
                                            </td>
                                            <td style="border: 1px solid #000" align="center">{{ $total_previous_land_amound }}</td>
                                            <td style="border: 1px solid #000" align="center">{{ $total_previous_yield }}</td>
                                            <td style="border: 1px solid #000" align="center">{{ $total_previous_total_production }}</td>
                                            <td style="border: 1px solid #000" align="center">{{ $total_current_land_amound }}</td>
                                            <td style="border: 1px solid #000" align="center">{{ $total_current_yield }}</td>
                                            <td style="border: 1px solid #000" align="center">{{ $total_current_total_production }}</td>
                                            <td style="border: 1px solid #000" align="center">{{ $data }}</td>
                                        </tr>
                                        <tr>
                                            {{-- <td style="border: 1px solid #000" align="center"></td>
                                            <td style="border: 1px solid #000" align="center"></td>
