    ...
    <tbody>
        @if ($lists->count() > 0)
            ...
            @foreach ($lists as $list)
                ...
                <td class="text-left">{{ $list->surveyCountWageDivision( $list->division_id)}}</td>
                ...
                <td>
                    ...
                    <a href="{{ route('admin.processingList.divisionReportShankalan8',['list'=>$list,'division_id'=>$list->division_id]) }}" class="btn btn-info btn-sm">Details</a>
            ...
            @endforeach
            <a href="{{ route('admin.processingList.allWagesData',['list'=>$list]) }}" class="w3-btn w3-teal w3-shadow-black" style="box-shadow: 0 8px 16px 0 rgb(0 0 0 / 20%), 0 6px 20px 0 rgb(0 0 0 / 19%);"> সকল তথ্য</a>
