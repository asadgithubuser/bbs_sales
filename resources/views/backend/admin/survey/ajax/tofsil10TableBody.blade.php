        ...
        @if ($lists->count() > 0)
            ...
            @foreach ($lists as $list)
                <tr>
                    ...
                    <td class="text-left">{{ $list->tofsil10Count()}}</td>
            ...
            @endforeach
            <a href="{{ route('admin.processingList.showUpazilaTofsil8', $list) }}" class="w3-btn w3-teal w3-shadow-black" style="box-shadow: 0 8px 16px 0 rgb(0 0 0 / 20%), 0 6px 20px 0 rgb(0 0 0 / 19%);">উপজেলার সকল তথ্য</a>
        @else
            <tr class="odd">
