    ...
    <tbody>
        @if ($lists->count() > 0)
            ...
            @foreach ($lists as $list)
                ...
                <td class="text-left">{{ $list->surveyCountClusterDivi($list->division_id)}}</td>
                ...
                <td>
                    ...
                    <a href="{{ route('admin.processingList.showAllDistrict',['list'=>$list->division_id,'form'=>$list->survey_form_id]) }}" class="btn btn-warning btn-sm">All List</a>
                    <a href="{{ route('admin.processingList.divisionClusterData',$list) }}" class="btn btn-info btn-sm">View</a>
