    ...
    <tbody>
        @if ($lists->count() > 0)
            ...
            @foreach ($lists as $list)
                ...
                <td class="text-left">{{ $list->surveyCountMaizeDivision( $list->division_id)}}</td>
                ...
                <td>
                    ...
                    <a href="{{ route('admin.processingList.showDGShonkolon6', $list) }}" class="btn btn-info btn-sm">Report</a>
