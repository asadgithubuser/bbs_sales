        ...
        @if ($lists->count() > 0)
            ...
            @foreach ($lists as $list)
                ...
                <td>
                    ...
                    <a href="{{ route('admin.processingList.zilaPerennialCropData', $list) }}" class="btn btn-info btn-sm">Report</a>
            ...
            <a href="{{ route('admin.processingList.divisionPermanentData',$list) }}" class="w3-btn w3-teal w3-shadow-black" style="box-shadow: 0 8px 16px 0 rgb(0 0 0 / 20%), 0 6px 20px 0 rgb(0 0 0 / 19%);"> বিভাগের সকল তথ্য </a>
