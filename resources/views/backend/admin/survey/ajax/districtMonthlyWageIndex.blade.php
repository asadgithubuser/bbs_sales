    ...
    <tbody>
        @if ($lists->count() > 0)
            ...
            @foreach ($lists as $list)
                ...
                <td class="text-left">{{ $list->surveyCountWagesDistrict( $list->district_id)}}</td>
                ...
                <td>
                    ...
                    <a href="{{ route('admin.processingList.divisionWages',['list'=>$list,'district_id'=>$list->district_id]) }}" class="btn btn-sm btn-info" >Details</a>
            ...
            <a href="{{ route('admin.processingList.divisionReportShankalan8',['list'=>$list,'division_id'=>$list->division_id]) }}" class="w3-btn w3-teal w3-shadow-black" style="box-shadow: 0 8px 16px 0 rgb(0 0 0 / 20%), 0 6px 20px 0 rgb(0 0 0 / 19%);">বিভাগের সকল তথ্য</a>
