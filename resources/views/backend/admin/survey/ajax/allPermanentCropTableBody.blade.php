    ...
    <tbody>
        @if ($lists->count() > 0)
            ...
            @foreach ($lists as $list)
                ...
                <td class="text-left">{{ $list->surveyCountTemporaryCropDivision( $list->division_id)}}</td>
                ...
                <td>
                    ...
                    {{-- <a href="{{ route('admin.processingList.divisionTemporaryData', $list) }}" class="btn btn-info btn-sm">Report</a> --}}
                    <a href="{{ route('admin.processingList.divisionPermanentData', $list) }}" class="btn btn-info btn-sm">Report</a>
