    ...
    <tbody>
        @if ($lists->count() > 0)
            ...
            @foreach ($lists as $list)
                ...
                <td class="text-left">{{ $list->surveyCountTemporaryDistrict( $list->district_id)}}</td>
                ...
                <td>
                    ...
                    {{-- <a href="{{ route('admin.processingList.showDistrictCluster',$list->district_id) }}" class="btn btn-warning btn-sm">View</a> --}}
                    <a href="{{ route('admin.processingList.zilaTemporaryData', $list) }}" class="btn btn-info btn-sm">Report</a>
                ...
                <div class="modal fade" id="exampleModalCenter{{$list->id}}" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-bottom" role="document">
                       <div class="modal-content">
                          ...
                          <form action="{{ route('admin.processingList.commentDivisionTofsil3', $list) }}" method="post">
                            @csrf
            ...
            <a href="{{ route('admin.processingList.divisionTemporaryData',$list) }}" class="w3-btn w3-teal w3-shadow-black" style="box-shadow: 0 8px 16px 0 rgb(0 0 0 / 20%), 0 6px 20px 0 rgb(0 0 0 / 19%);">বিভাগের সকল তথ্য</a>
