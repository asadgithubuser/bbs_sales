<table class="table table-separate table-head-custom table-checkable table-striped">
    ...
    <tbody>
        @if ($lists->count() > 0)
            ...
            @foreach ($lists as $list)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.processingList.showListOfFarmer',$list) }}" class="btn btn-info btn-sm">Details</a>
                        @endif
                    </td>
                @php
                    $i++;
            ...
            @endforeach
            @if ($list->status == 2)
                <a href="{{ route('admin.processingList.showDistrictShankalan7',$list) }}" class="w3-btn w3-teal w3-shadow-black" style="box-shadow: 0 8px 16px 0 rgb(0 0 0 / 20%), 0 6px 20px 0 rgb(0 0 0 / 19%);">উপজেলার সকল তথ্য </a>
            @endif
        @else
            <tr class="odd">
