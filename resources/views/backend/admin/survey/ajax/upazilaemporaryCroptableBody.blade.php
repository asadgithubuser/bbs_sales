        ...
        @if ($lists->count() > 0)
            ...
            @foreach ($lists as $list)
                <tr>
                    ...
                    <td class="text-left">{{ $list->surveyTemporaryCropCount()}}</td>
                    ...
                    @if ($list->status == 2)
                        ...
                        <a href="{{ route('admin.processingList.showUpazilaTofsil3', $list) }}" class="btn btn-info btn-sm">Report</a>
                ...
                <div class="modal fade" id="exampleModalCenter{{$list->id}}" tabindex="-1" aria-labelledby="exampleModalCenterTitle" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-bottom" role="document">
                       <div class="modal-content">
                          ...
                          <form action="{{ route('admin.processingList.commentUpazilaTofsil3', $list) }}" method="post">
                            @csrf
            ...
            @endforeach
            @if ($list->status == 2)
                <a href="{{ route('admin.processingList.upazilaTemporaryData', $list) }}" class="w3-btn w3-teal w3-shadow-black" style="box-shadow: 0 8px 16px 0 rgb(0 0 0 / 20%), 0 6px 20px 0 rgb(0 0 0 / 19%);">উপজেলার সকল তথ্য</a>
            @endif
