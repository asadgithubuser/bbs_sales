<table class="table table-separate table-head-custom table-checkable table-striped">
    ...
    <tbody>
        @if ($lists->count() > 0)
            ...
            <a href="{{route('admin.processingList.agriclutureFarmerReportDistrict',['list' =>$list, 'district_id' => $list->district_id] )}}" class="w3-btn w3-teal w3-shadow-black ml-2" style="box-shadow: 0 8px 16px 0 rgb(0 0 0 / 20%), 0 6px 20px 0 rgb(0 0 0 / 19%);">উপজেলার সকল কৃষি খানা</a>
