        ...
        @if ($lists->count() > 0)
            ...
            @foreach ($lists as $list)
                <tr>
                    ...
                    <td>{{ $list->surveyCountForecastDistrict($list->district_id) }}</td>
                    ...
                    <td>
                        ...
                        {{-- <a href="{{ route('admin.processingList.showDistrictTofsil11', $list) }}" class="btn btn-info btn-sm">Report</a> --}}
            ...
            @endforeach
            <a href="{{ route('admin.processingList.showDistrictTofsil10', $list) }}" class="w3-btn w3-teal w3-shadow-black" style="box-shadow: 0 8px 16px 0 rgb(0 0 0 / 20%), 0 6px 20px 0 rgb(0 0 0 / 19%);">জেলার সকল তথ্য</a>
