                        ...
                        <div class="card card-custom" style="font-size: 90%;">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p style="font-size: 1.3em; font-weight: 500">জেলা: <b>{{ $list->district ?$list->district->name_bn : ''}}</b></p>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <table class="table" style="margin-bottom: 25px">
                                        ...
                                        @foreach ($shankalan7datas as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->upazila->name_bd :'' }}</td>
                                                {{-- <td style="border: 1px solid #000" align="center"></td>
                                                <td style="border: 1px solid #000" align="center"></td> --}}
                                                <td style="border: 1px solid #000" align="center">
                                                    {{ $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'arable_land','main') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="center">
                                                    {{ $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'total_production','main') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="center">
                                                     {{ $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'area_rent_amount_per_year','landRent') }}
                                                    
                                                </td>
                                                <td style="border: 1px solid #000" align="center">
                                                    {{ $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'land_rent_amount','landRent') }}
                                                </td>
                                                <td style="border: 1px solid #000" align="center">
                                                    
                                                    @if ($data->landCultivateCost)
                                                        {{  $totalKorsonCost = $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'own_korshon_amount','chasKora') + $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'rent_korshon_amount','chasKora') + $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'power_tiler_korshon_amount','chasKora') +$data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'sromik_mojuri_amount','chasKora') +$data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'paribarik_sromik_amount','chasKora')}}
                                                    @else 
                                                    -
                                                    @endif
                                                </td>
                                                <td style="border: 1px solid #000" align="center">
                                                    @if ($data->landSeedsCost)
                                                        {{ $totalSeedCost =  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'seed_value','seed') + $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'seedlings_value','seed') + $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'when_own_seed_value','seed') }}
                                                ...
                                                <td style="border: 1px solid #000" align="center">
                                                    ...
                                                    {{   $totalFertilizerCost =
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'tsp_cost','fertilizer') +
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'mop_cost','fertilizer')+
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'dap_cost','fertilizer')+
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'gypsum_cost','fertilizer')+
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'nixar_cost','fertilizer')+
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'other_inorganic_cost','fertilizer')+
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'gobor_cost','fertilizer')+
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'ash_cost','fertilizer')
                                                    +
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'green_cost','fertilizer')
                                                    +
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'other_organic_cost','fertilizer')
                                                    }}
                                                    @else 
                                                    -
                                                    @endif
                                                ...
                                                <td style="border: 1px solid #000" align="center">
                                                    ...
                                                    {{  $totalIrrigationCost = $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'tubewell_cost','landIrrigationCost')  +  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'chapcol_cost', 'landIrrigationCost') +  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'jalani_cost','landIrrigationCost')}}
                                                ...
                                                <td style="border: 1px solid #000" align="center">
                                                    ...
                                                    {{ $totalWorkerCost =  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'seedling_total_worker_cost','landWorkerCost') +  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'nirani_total_worker_cost','landWorkerCost')+  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'crop_cutting_total_worker_cost','landWorkerCost')+  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'crop_marai_total_worker_cost','landWorkerCost')+  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'jute_total_worker_cost','landWorkerCost')+ $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'other_total_worker_cost','landWorkerCost')
                                                    }}
                                                ...
                                                <td style="border: 1px solid #000" align="center">
                                                    ...
                                                    {{  $totalPesticideCost = $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'sumithion_cost','landPesticideCost') + 
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'malathion_cost','landPesticideCost') + 
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'basudin_cost','landPesticideCost') + 
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'furadon_cost','landPesticideCost') + 
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'furanol_cost','landPesticideCost') + 
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'other_cost','landPesticideCost')  }}
                                                ...
                                                <td style="border: 1px solid #000" align="center">
                                                    ...
                                                    {{ $totaltransportCost =  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'land_things_transport_cost','landtransportCost') + 
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'seed_transport_cost','landtransportCost') + 
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'fertilizer_transport_cost','landtransportCost') + 
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'irrigation_transport_cost','landtransportCost') + 
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'pesticide_transport_cost','landtransportCost') + 
                                                    $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'other_transport_cost','landtransportCost')  }}
                                                ...
                                                <td style="border: 1px solid #000" align="center">
                                                    {{ $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'crops_total_value_tk','main') }}
                                                    
                                                </td>
                                                <td style="border: 1px solid #000" align="center">
                                                    {{ $profit =$data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'crops_total_value_tk','main')- $totalCost }}
                                                </td>
                                            </tr>
                                            @php
                                                $totalLandAmount +=  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'arable_land','main');

                                                $toalProductionInLand   +=  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'total_production','main') ;

                                                $totalLandFareCurrentYear +=  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'area_rent_amount_per_year','landRent') ;

                                                $totalLandFareForthisLand +=  $data->upazilaDatas($data->id,$data->survey_notification_id,$data->upazila_id,'land_rent_amount','landRent') ;
