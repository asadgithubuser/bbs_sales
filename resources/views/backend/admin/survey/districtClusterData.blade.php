                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom m-9">
                            <div class="card-header mt-5">
                                ...
                                <div class="col-3">
                                    <p class="font-weight-bold text-right">দাগগুচ্ছ জরিপ প্রতিবেদন (জেলা)</p>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="5">বিভাগ: {{$list->division ? $list->division->name_en : ''}}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="5">জেলা: {{$list->district ? $list->district->name_en : ''}}</td>
                                            {{-- <td style="border: 1px solid #000" align="left" colspan="2">উপজেলা/থানা:{{$list->upazila ? $list->upazila->name_en : ''}}</td> --}}
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="5">কোড:{{$list->division ? $list->division->division_bbs_code : ''}}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="5">কোড:{{$list->district ? $list->district->district_bbs_code : ''}}</td>
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" rowspan="3">উপজেলা</td>
                                        ...
                                        @php
                                            $data = 0;
                                            foreach ($cluster->upazilaData($cluster->upazila_id) as $key) {

                                                $data = $data + 1;
                                            }
                                        @endphp
                                            <tr>
                                                <td style="border: 1px solid #000" align="left" rowspan="{{ $data + 1 }}">{{ $cluster->upazila ? $cluster->upazila->name_bd : '' }}</td>
                                                @foreach ($cluster->upazilaData($cluster->upazila_id) as $item)
                                                <tr>
                                                    <td style="border: 1px solid #000" align="left">{{$item->land_identification_no}}</td>
                                                    {{-- <td style="border: 1px solid #000" align="left">
                                                        {{$item->cluster ? $item->cluster->name_en :''}} 
                                                    </td> --}}
                                                    <td style="border: 1px solid #000" align="left">
                                                        {{$item->crop ? $item->crop->name_en : ''}}
                                                    </td>
                                                    <td style="border: 1px solid #000" align="left">
                                                        {{$item->crop ? $item->crop->code : ''}}
                                                    </td>
                                                    <td style="border: 1px solid #000" align="left"></td>
                                                    <td style="border: 1px solid #000" align="left">{{ $item->land_amount }}</td>
                                                    <td style="border: 1px solid #000" align="left">{{$item->how_many_cultivated_time_yearly}}</td>
                                                    <td style="border: 1px solid #000" align="left">{{$item->cultivated_method}}</td>
                                                    <td style="border: 1px solid #000" align="left">
                                                        @if ($item->irrigation_system == 1)
                                                            No Irrigation
                                                        @elseif($item->irrigation_system == 2)
                                                            Power Pump
                                                        @elseif($item->irrigation_system == 3)
                                                            Deep Tubewell
                                                        @elseif($item->irrigation_system == 4)
                                                            Shallow Tubewell
                                                        @elseif($item->irrigation_system == 5)
                                                            Manual Tubewell
                                                        @elseif($item->irrigation_system == 6)
                                                            Traditional & Others
                                                        @else
                                                            Not defined
                                                        @endif
                                                    ...
                                                    <td style="border: 1px solid #000" align="left">
                                                        ...
                                                        @if ($item->how_many_irrigation_time == 1)
                                                        একবার
                                                        @elseif($item->how_many_irrigation_time == 2)
                                                        দুইবার 
                                                        @elseif($item->how_many_irrigation_time == 3)
                                                        তিনবার 
                                                        @endif
