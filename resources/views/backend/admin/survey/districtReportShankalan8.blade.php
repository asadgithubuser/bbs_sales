                                    ...
                                    <table class="table">
                                        ...
                                        @foreach ($upazilaDatas as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getUpazilaData($data->upazila_id,'one_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getUpazilaData($data->upazila_id,'one_meal_female') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getUpazilaData($data->upazila_id,'two_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getUpazilaData($data->upazila_id,'two_meal_female') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getUpazilaData($data->upazila_id,'three_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getUpazilaData($data->upazila_id,'three_meal_female') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getUpazilaData($data->upazila_id,'without_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getUpazilaData($data->upazila_id,'without_meal_female') :'' }}</td>
                                            </tr>
                                            @php
                                                $total_one_meal_male += $data->upazila ? $data->getUpazilaData($data->upazila_id,'one_meal_male') :'' ;
                                                $total_one_meal_female += $data->upazila ? $data->getUpazilaData($data->upazila_id,'one_meal_female') :'' ;
                                                $total_two_meal_male += $data->upazila ? $data->getUpazilaData($data->upazila_id,'two_meal_male') :'';
                                                $total_two_meal_female += $data->upazila ? $data->getUpazilaData($data->upazila_id,'two_meal_female') :'';
                                                $total_three_meal_male += $data->upazila ? $data->getUpazilaData($data->upazila_id,'two_meal_female') :'';
                                                $total_three_meal_female += $data->upazila ? $data->getUpazilaData($data->upazila_id,'three_meal_male') :'';
                                                $total_without_meal_male +=  $data->upazila ? $data->getUpazilaData($data->upazila_id,'without_meal_male') :'';
                                                $total_without_meal_female += $data->upazila ? $data->getUpazilaData($data->upazila_id,'without_meal_female') :'';
                                            @endphp
                                        @endforeach
                                        {{-- End loop --}}
