                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="3">ফসলের নাম:</td>
                                ...
                                <div class="row">
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="border: none;"  align="left">.......টি</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="border: none;" align="left" rowspan="2">৮। বিভাগ/জেলা/উপজেলা/থানায় গত বছর হতে চলতি বছরে উৎপাদন ও ফলন হার হ্রাস/বৃদ্ধির কারণ (মে.টন):</td>
