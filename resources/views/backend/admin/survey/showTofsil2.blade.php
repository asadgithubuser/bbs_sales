                        ...
                        <div class="card card-custom m-9">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    <p style="font-size: 1.4em; font-weight: 600">১। নমুনা দাগ্ গুচ্ছের পরিচিতি :</p>
                                    <table class="table">
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="2">ইউনিয়ন: <b>{{ $list->union ? $list->union->name_bn : ''}}</b></td>
                                            <td style="border: 1px solid #000" align="left" colspan="2">মৌজা: <b>{{ $list->mouza ? $list->mouza->name_bn : ''}}</b></td>
                                            <td style="border: 1px solid #000" align="left" colspan="2">দাগ্ গুচ্ছের সংকেত নং (প্রযোজ্য ক্ষেত্রে):</td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="left">কোড</td>
                                            <td style="border: 1px solid #000" align="left"><b>{{ $list->union ? $list->union->nunion_bbs_code : ''}}</b></td>
                                            <td style="border: 1px solid #000" align="left">কোড</td>
                                            <td style="border: 1px solid #000" align="left"><b>{{ $list->mouza ? $list->mouza->nmouza_bbs_code : ''}}</b></td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left" colspan="3">{{ $cropCuttingProducts->land_segment_signal }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="2">নমুনার অবস্থান: (কোড: দাগ্ গুচ্ছের ভেতরে হলে 1 এবং দাগ্গুচ্ছের বহির্ভূত হলে 2)</td>
                                            <td style="border: 1px solid #000" align="left" colspan="2">{{ $cropCuttingProducts->in_cluster }}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="2">ফসল কর্তনের তারিখ : {{ $cropCuttingProducts->crop_cutting_date }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="4" rowspan="2">চাষীর নাম ও মোবাইল নম্বর: {{ $cropCuttingProducts->farmer ? $cropCuttingProducts->farmer->farmers_name : '' }}, {{ $cropCuttingProducts->farmer ? $cropCuttingProducts->farmer->farmers_mobile : '' }}</td>
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="right" rowspan="2">দাগ্ গুচ্ছের আয়তন: </td>
                                            <td style="border: 1px solid #000" align="left">একর</td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="left">{{ $cropCuttingProducts->cluster_area_acre ? $cropCuttingProducts->cluster_area_acre : '-'}}</td>
                                        </tr>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td style="border: 1px solid #000" align="center" colspan="3">দক্ষিণ-পশ্চিম কর্ণার হতে পূর্ব-দক্ষিণ কর্ণারের দূরত্ব {{ $cropCuttingProducts->plot_corner_point_1 }} ফুট</td>
                                            
                                            <td style="border: 1px solid #000" align="center" colspan="2">দক্ষিণ-পশ্চিম কর্ণার হতে উত্তর-পশ্চিম কর্ণারের দূরত্ব {{ $cropCuttingProducts->plot_corner_point_2 }} ফুট</td>
                                            
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="center" rowspan="2">{{ $cropCuttingProducts->amount_of_land }}</td>
                                            <td style="border: 1px solid #000" align="center" colspan="3">উত্তর প্রান্ত হতে ৯ ফুটবাদ দিয়ে ২ট সংখ্যা পাওয়া যাবে ৯ এবং {{ $cropCuttingProducts->point_1_number }}</td>
                                            <td style="border: 1px solid #000" align="center" colspan="2">উত্তর প্রান্ত হতে ৯ ফুটবাদ দিয়ে ২ট সংখ্যা পাওয়া যাবে ৯ এবং {{ $cropCuttingProducts->point_2_number }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="center" colspan="3">৯ এবং {{ $cropCuttingProducts->point_1_number }} এর মধ্যে দৈবচয়িত সংখ্যা {{ 	$cropCuttingProducts->point_1_random }}</td>
                                            <td style="border: 1px solid #000" align="center" colspan="2">৯ এবং {{ $cropCuttingProducts->point_2_number }} এর মধ্যে দৈবচয়িত সংখ্যা {{ $cropCuttingProducts->point_2_random }}</td>
                                        </tr>
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->crop ? $cropCuttingProducts->crop->code :'' }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;" align="left">১.৩ চাষের ধরণের কোড লিখুন </td>
                                            <td style="border:none;" align="left">{{ 	$cropCuttingProducts->type_of_cultivation }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;" align="left">১.৪ ফসলের ধরণের কোড লিখুন</td>
                                            <td style="border:none;" align="left">{{ 	$cropCuttingProducts->crop_type_code  }}</td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="center" colspan="2">{{ 	$cropCuttingProducts->after_harvesting_paddy_kg }} </td>
                                            <td style="border: 1px solid #000" align="center" colspan="2">{{ 	$cropCuttingProducts->after_harvesting_wheat_kg ? $cropCuttingProducts->after_harvesting_wheat_kg : '-' }}</td>
                                            <td style="border: 1px solid #000" align="center" colspan="2">{{ $cropCuttingProducts->after_harvesting_jute_kg ?	$cropCuttingProducts->after_harvesting_jute_kg : '-'}}</td>
                                        </tr>
                                        <tr>
                                            <td align="left" colspan="6">১.৬ ধানের ক্ষেত্রে পরিমাপকৃত ধানের আদ্রতার হার (moisture)</td>
                                            <td align="left">{{ $cropCuttingProducts->paddy_moisture }} %</td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->water_irrigation }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;" align="left">(খ) হ্যা হলে পানির উৎসের কোড লিখুন (প্রাকৃতিক-1, যান্ত্রিক-2, উভয়-3)</td>
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->source_of_water }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;" align="left">(গ) পানি সেচ পর্যাপ্ত ছিল কি? (উত্তর হ্যা হলে কোড লিখুন: পর্যাপ্ত-1, মাঝারি-2, অপর্যাপ্ত-3)</td>
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->is_water_irrigation_both	 }}</td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->has_used_fertilizer }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;" align="left">(খ) হ্যা হলে কোন ধরণের সার ব্যবহার হয়েছে তার কোড লিখুন (কোড: রাসায়নিক সার-1, জৈব-2)</td>
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->what_type_fertilizer	}}</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->what_used_fertilizer	}}</td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;" align="left">(ঘ) পরিমান লিখুন (কেজি)</td>
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->fertilizer_amound }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;" align="left">(ঙ) পরিমান লিখুন (লিটার)</td>
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->fertilizer_amound_lit }}</td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->is_used_pesticide }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;" align="left">(খ) কোন ধরণের বালাইনাশক ব্যবহার হয়েছে তার কোড লিখুন (কোড: প্রাকৃতিক-1, রাসায়নিক-2, উভয়-3)</td>
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->what_type_pesticide }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border:none;" align="left">(গ) ব্যবহারের পরিমাণ (লিটার)</td>
                                            <td style="border:none;" align="left">{{ $cropCuttingProducts->pesticide_amound }}</td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="center" colspan="2">পূর্ববর্তী বছর {{ date("Y", strtotime("-1 year")) }}</td>
                                            <td style="border: 1px solid #000" align="center" colspan="2">চলতি বছর {{ date('Y') }}</td>
                                        ...
                                        <tr>
                                            ...
                                            @php
                                                ...
                                                $total_last_year_production = 0;
                                                $total_current_year_production = 0;
                                            @endphp
                                        @foreach ($farmersData as $data)
                                            <tr>
                                                <td style="border: 1px solid #000; vertical-align: middle;" align="center">১।</td>
                                                <td style="border: 1px solid #000" align="left" colspan="2">নাম: {{ $data->farmer->farmers_name }} <br> পিতার নাম : {{ $data->fathers_name}} <br> মোবাইল নম্বর : {{ $data->farmer->farmers_mobile }} </td>
                                                <td style="border: 1px solid #000" align="left">{{ $data->last_year_land_amount }}</td>
                                                <td style="border: 1px solid #000" align="left">{{ $data->last_year_land_producttion }}</td>
                                                <td style="border: 1px solid #000" align="left">{{ $data->current_year_land_amount }}</td>
                                                <td style="border: 1px solid #000" align="left">{{ $data->current_year_land_producttion }}</td>
                                                <td style="border: 1px solid #000" align="left">{{ $data->comments }}</td>

                                                @php
                                                    $total_last_year_land_amount +=  $data->last_year_land_amount;

                                                    $total_current_year_land_amount += $data->current_year_land_amount;

                                                    $total_last_year_production += $data->last_year_land_producttion;
                                                    $total_current_year_production += $data->current_year_land_producttion;
                                                @endphp
                                            </tr>
                                        @endforeach
                                        <tr>
                                            <td style="border: 1px solid #000" align="right" colspan="3">মোট=</td>
                                            <td style="border: 1px solid #000" align="left">{{ $total_last_year_land_amount }}</td>
                                            <td style="border: 1px solid #000" align="left">{{ $total_last_year_production }}</td>
                                            <td style="border: 1px solid #000" align="left">{{ $total_current_year_land_amount }}</td>
                                            <td style="border: 1px solid #000" align="left">{{ $total_current_year_production }}</td>
                                            <td style="border: 1px solid #000" align="left"></td>
                                        </tr>
                                    </table>
                                </div>
                                    ...
                                    <div class="col-lg-12 mt-20">
                                        <div class="row">
                                            <div class="col-lg-4 ml-8">
                                                ...
                                                <p>উপজেলা কৃষি কর্মকর্তা/প্রতিনিধির স্বাক্ষর: <img src="{{ asset('storage/signatures/'.$cropCuttingProducts->agricultural_officer_signature) }}" height="100" width="100" alt=""></p>
                                                <p>নাম: {{  $cropCuttingProducts->agricultural_officer_name }}</p>
                                                <p>পদবি: {{ $cropCuttingProducts->agricultural_officer_designation }}</p>
                                                <p>তারিখ: {{ $cropCuttingProducts->created_at->format('d-m-Y') }}</p>
                                                <p>উপজেলা: {{ $cropCuttingProducts->agricultural_officer_upazila }}</p>
                                                <p>(সীল)</p>
                                            </div>
                                            <div class="col-lg-3"></div>
                                            <div class="col-lg-4 text-right mr-8">
                                                <p class="text-center">বাংলাদেশ পরিসংখ্যান ব্যুরো (বিবিএস)</p>
                                                <p class="text-left">তথ্য সংগ্রহকারীর নাম: 
                                                    @if ($serveyBy = $cropCuttingProducts->processList)
                                                    {{ $serveyBy->surveyBy ? $serveyBy->surveyBy->first_name : '' }}
                                                    @endif 
                                                </p>
                                                <p class="text-left">উপজেলা/থানা পরিসংখ্যান কর্মকর্তার নাম: @if ($serveyBy = $cropCuttingProducts->processList)
                                                    {{ $serveyBy->surveyBy ? $serveyBy->createdBy->first_name : '' }}
                                                    @endif</p>
                                                <p class="text-left">উপজেলা/থানা পরিসংখ্যান কর্মকর্তার স্বাক্ষর: @if ($serveyBy = $cropCuttingProducts->processList)
                                                    <img src="{{ asset('storage/signatures/'.$serveyBy->createdBy->signature) }}" alt="" height="100" width="100">
                                                    @endif</p>
                                                <p class="text-left">তারিখ: {{ $cropCuttingProducts->created_at->format('d-m-Y') }}</p>
                                        ...
                                        <p>১। ফসল কর্তন জরিপের মূল উদ্দ্যেশ্যহলো সঠিকভাবে কর্তনকৃত ফসলের ভিত্তিতে সে এলাকার একর প্রতি ফসলের উৎপাদন/ফলন হার প্রাক্কলন করা। নমুনা দাগ্গুচ্ছে প্রধানত: ফসলের (ধান, গম ও পাট) জাতভেদে কর্তন করতে হবে। বিশেষ ক্ষেত্রে দাগ্ গুচ্ছের বাহিরে কোন জমিতে কর্তন করা যেতে পারে।</p>
                                        ...
                                        <p>৫। যদি ফসল কর্তন দাগ্ গুচ্ছের বাহিরে কোন জমিতে করা হয় তাহলে দাগ্ গুচ্ছের নং এর ঘর খালি থাকবে এবং ভূমিখণ্ডের সংকেত নং এর ঘরে মূল দাগ নং দিতে হবে। </p>
