                        ...
                        <div class="card card-custom m-9">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 1px solid #000" align="middle" rowspan="2">উপজেলা</td>
                                        ...
                                        @foreach ($maizes as $maize)
                                            @php
                                                $data = 0;
                                                foreach ($maize->upazilaCrops($maize->upazila_id) as $key) {

                                                    $data = $data + 1;
                                                }
                                            @endphp
                                            <tr>
                                                <td style="border: 1px solid #000" align="left" rowspan="{{ $data + 1 }}">{{ $maize->upazila ? $maize->upazila->name_bd : '' }}</td>
                                                @foreach ($maize->upazilaCrops($maize->upazila_id) as $item)
                                                    <tr>
