                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table" style="margin-bottom: 25px">
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="2">বিভাগের নাম:{{ $list->division ? $list->division->name_bn :'' }}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="2">জেলার নাম:{{ $list->district ? $list->district->name_bn :'' }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left">{{ $list->created_at->format('F') }}</td>
                                            <td style="border: 1px solid #000" align="left">{{ $list->created_at->format('Y') }}</td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="center" rowspan="3">উপজেলা</td>
                                        ...
                                        @endphp
                                        {{-- Start loop --}}
                                        @foreach ($divisionDatas as $data)
                                            
                                            <tr>
                                                <td style="border: 1px solid #000" align="center">{{ $loop->index + 1 }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->upazila->name_bd :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDistrictData($data->district_id,'one_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDistrictData($data->district_id,'one_meal_female') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDistrictData($data->district_id,'two_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDistrictData($data->district_id,'two_meal_female') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDistrictData($data->district_id,'three_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDistrictData($data->district_id,'three_meal_female') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDistrictData($data->district_id,'without_meal_male') :'' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{ $data->upazila ? $data->getDistrictData($data->district_id,'without_meal_female') :'' }}</td>
                                            </tr>
                                            @php
                                                $total_one_meal_male += $data->upazila ? $data->getDistrictData($data->district_id,'one_meal_male') :'' ;
                                                $total_one_meal_female += $data->upazila ? $data->getDistrictData($data->district_id,'one_meal_female') :'' ;
                                                $total_two_meal_male += $data->upazila ? $data->getDistrictData($data->district_id,'two_meal_male') :'';
                                                $total_two_meal_female += $data->upazila ? $data->getDistrictData($data->district_id,'two_meal_female') :'';
                                                $total_three_meal_male += $data->upazila ? $data->getDistrictData($data->district_id,'two_meal_female') :'';
                                                $total_three_meal_female += $data->upazila ? $data->getDistrictData($data->district_id,'three_meal_male') :'';
                                                $total_without_meal_male +=  $data->upazila ? $data->getDistrictData($data->district_id,'without_meal_male') :'';
                                                $total_without_meal_female += $data->upazila ? $data->getDistrictData($data->district_id,'without_meal_female') :'';
                                            @endphp
                                        @endforeach
                                        {{-- End loop --}}
