                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table" style="margin-bottom: 25px">
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="3">বিভাগ: {{ $list->division ? $list->division->name_bn : '' }}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="3">জেলা: {{ $list->district ? $list->district->name_bn : '' }}</td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="left">কোড</td>
                                            <td style="border: 1px solid #000" align="left" colspan="2">{{ $list->division ? $list->division->division_bbs_code : '' }}</td>
                                            <td style="border: 1px solid #000" align="left">কোড</td>
                                            <td style="border: 1px solid #000" align="left" colspan="2">{{ $list->district ? $list->district->district_bbs_code: '' }}</td>
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 1px solid #000" align="center" rowspan="2">উপজেলা</td>
                                        ...
                                        @php
                                            // upazila total data
                                            $upazilaTotalLand = 0;
                                            $upazilaTotalPersialDamage = 0;
                                            $upazilaTotalDamagePercentage = 0;
                                            $upazilaTotalPersialToFullDamage = 0;
                                            $upazilaTotalCompleteDamage = 0;
                                            $upazilaTotalSummationDamage = 0;
                                            $upazilaTotalEstimatedYield = 0;
                                            $upazilaTotalEstimatedCropLoss = 0;
                                        ...
                                        @foreach ($tofsil11datas as $ata)
                                            @foreach ($ata->upazilaDatas($ata->upazila_id) as $data)
                                            @php
                                                $upazilaTotalLand += $data->land_amound;
                                                $upazilaTotalPersialDamage += $data->partial_damage;
                                                $upazilaTotalDamagePercentage += $data->percentage_of_damage;
                                                $upazilaTotalPersialToFullDamage += $data->partial_damage_to_total_damage;
                                                $upazilaTotalCompleteDamage += $data->complete_damage;
                                                $upazilaTotalSummationDamage += $data->partial_damage_to_total_damage + $data->complete_damage;
                                                $upazilaTotalEstimatedYield += $data->yield_per_desired_acre;
                                                $upazilaTotalEstimatedCropLoss += $data->estimated_amount_of_crop_loss;
                                                $TotalMoneyLoss += $data->amount_of_crop_loss_tk;
                                            @endphp
                                            @endforeach
                                            <tr>
                                                <td style="border: 1px solid #000" align="center">{{ $list->upazila ? $list->upazila->name_bd : '' }}</td>
                                                <td style="border: 1px solid #000" align="center">{{$upazilaTotalLand}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$upazilaTotalPersialDamage}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$upazilaTotalDamagePercentage}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$upazilaTotalPersialToFullDamage}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$upazilaTotalCompleteDamage}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$upazilaTotalSummationDamage}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$upazilaTotalEstimatedYield}}</td>
                                                <td style="border: 1px solid #000" align="center">{{$upazilaTotalEstimatedCropLoss}}</td>
                                            </tr>
                                            @php
                                                $finalTotalLand += $upazilaTotalLand;
                                                $finalTotalPersialDamage += $upazilaTotalPersialDamage;
                                                $finalTotalDamagePercentage += $upazilaTotalDamagePercentage;
                                                $finalTotalPersialToFullDamage += $upazilaTotalPersialToFullDamage;
                                                $finalTotalCompleteDamage += $upazilaTotalCompleteDamage;
                                                $finalTotalSummationDamage += $upazilaTotalSummationDamage;
                                                $finalTotalEstimatedYield += $upazilaTotalEstimatedYield;
                                                $finalTotalEstimatedCropLoss += $upazilaTotalEstimatedCropLoss;
                                            @endphp
                                        @endforeach
                                        {{-- End loop --}}
                                        <tr>
