                                ...
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        ...
                                        {{-- <tr>
                                            ...
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="middle"><b>{{ $all_last_total_fruity_trees }}</b></td>
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="middle"><b>0</b></td>
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="middle"><b>{{ $all_last_total_trees }}</b></td>
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="middle"><b>{{ $all_total_fruity_trees }}</b></td>
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="middle"><b>{{ $all_total_fruitless_trees }}</b></td>
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="middle"><b>{{ $all_total_trees }}</b></td>
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="middle"><b>{{ $all_last_land_amount_under_the_fruitly_trees }}</b></td>
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="middle"><b>{{ $all_land_amount_under_the_fruitly_trees }}</b></td>
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="middle"><b>{{ number_format((float)$all_last_average_yield_per_tree, 4, '.', '') }}</b></td>
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="middle"><b>{{ number_format((float)$all_average_yield_per_tree, 4, '.', '') }}</b></td>
                                        </tr> --}}
                                    </table>
                                </div>
