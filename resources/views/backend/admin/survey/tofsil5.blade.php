                                ...
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table" style="margin-bottom: 25px">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000" align="left"></td>
                                            <td style="border: 1px solid #000" align="left" colspan="3">ফসল কর্তনের তারিখ:</td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="3">চাষির নাম:</td>
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td align="left">১.৩ আলুর জাট (কোড লিখুন) (কোড: দেশী/স্থানীয়-১, উচ্চ ফলনশীল-২, ইন্ডিয়ান-৩)</td>
                                            <td style="border: 1px solid #000;" align="left"></td>
                                        </tr>
                                    </table>
                                    ...
                                    <p style="font-size: 1.3em; font-weight: 500; margin-bottom: 20px;">অংশ-২: আলু উৎপাদন সংক্রান্ত তথ্যাদি। (আলু কর্তনকৃত মৌজায় ৪ জন আলু চাষীর লিকোট হতে তথ্য সংগ্রহ করতে হবে)</p>
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 1px solid #000" align="center" rowspan="2">আলুর জাট/প্রকার</td>
