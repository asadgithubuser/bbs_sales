                        ...
                        <div class="card card-custom m-9">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <p style="font-size: 1.3em; font-weight: 500">নির্বাচিত ১ম দাগগুচ্ছ:</p>
                                    <table class="table">
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" rowspan="2" colspan="2">দাগগুচ্ছ নম্বর: {{ $list->cluster ? $list->cluster->mouza_id : '' }}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="3">ইউনিয়ন: {{ $list->cluster ? $list->cluster->union_id : ''}}</td>
                                            <td style="border: 1px solid #000" align="left" colspan="5">মৌজা: {{ $list->cluster ? $list->cluster->mouza_id : ''}}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        @endphp
                                        @foreach ($upazilaTotalData as $data)
