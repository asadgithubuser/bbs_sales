                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table" style="margin-bottom: 25px">
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="4">বাংলাদেশ</td>
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000; vertical-align: middle;" align="center" rowspan="3">বিভাগ</td>
                                        ...
                                        @foreach ($allDatas as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: 1px solid #000" align="center">{{ $data->division ? $data->division->name_bn :'' }}</td>
