                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-custom example example-compact">
                            <div class="card-header">
                                <h3 class="card-title">Cluster Suvery</h3>
                                <div class="d-flex align-items-center"> 
                                    <select data-url="{{ route('admin.searchAjax',['type'=> 'cropwiseData']) }}" name="q" class="form-control ajax-data-search" id="">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ajax-data-container pt-3">
                                    @include('backend.admin.survey.ajax.upazilaClustertableBody')                                    
                                </div>
                                {{$lists->links()}}
                            </div>
                        </div>
