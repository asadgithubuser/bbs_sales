                                ...
                                <div class="table-responsive ajax-data-container pt-3">
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach ($temporaryCrops as $temporaryCrop)
                                            @php
                                                $data = 0;
                                                foreach($temporaryCrop->moujaCrops($temporaryCrop->mouza_id) as $keydata)
                                                {
                                                    $data = $data ;
                                                }
                                            @endphp
                                            <tr>
                                                <td style="border: 1px solid #000" align="left" rowspan="{{ $data +1}}">  {{ $temporaryCrop->union ? $temporaryCrop->union->name_bn : '' }}</td> 
                                                
                                                    
                                                    <td style="border: 1px solid #000" align="left">{{  $temporaryCrop->allDataOfUnion($temporaryCrop->survey_notification_id,$temporaryCrop->union_id,'last_year_land_amount') }} </td>
                                                    <td style="border: 1px solid #000" align="left">{{  $temporaryCrop->allDataOfUnion($temporaryCrop->survey_notification_id,$temporaryCrop->union_id,'current_year_land_amount') }} </td>
                                                    <td style="border: 1px solid #000" align="left">{{  $temporaryCrop->allDataOfUnion($temporaryCrop->survey_notification_id,$temporaryCrop->union_id,'last_year_land_producttion') }} </td>
                                                    <td style="border: 1px solid #000" align="left">{{  $temporaryCrop->allDataOfUnion($temporaryCrop->survey_notification_id,$temporaryCrop->union_id,'current_year_land_producttion') }} </td>
                                                    <td style="border: 1px solid #000" align="left">{{  $temporaryCrop->allDataOfUnion($temporaryCrop->survey_notification_id,$temporaryCrop->union_id,'acre_reflection_rate') }}</td>
                                            ...
                                            @foreach ($temporaryCrop->moujaCropsUpazila($temporaryCrop->mouza_id) as $item)
                                            {{-- <tr>
                                        ...
                                        @endforeach
                                        <tr>
                                            <td style="border: 1px solid #000" align="left" colspan="1">মোট:</td>
                                            ...
                                            <td style="border: 1px solid #000" align="left">{{ number_format((float)$alltotalAcreReflection, 4, '.', '' )}}</td>
                                        </tr>
                                    </table>
                                </div>
