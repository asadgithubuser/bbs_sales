							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">All System Users List</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											@can('all_users')
												<li class="breadcrumb-item">
													<a href="{{route('admin.user.index')}}" class="text-muted">Manage System Users List</a>
												</li>
											@endcan
											<li class="breadcrumb-item active">
												<a class="text-muted">All System Users List</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<div class="col-lg-12">
										...
										<div class="card card-custom example example-compact">
											<div class="card-header">
												<h3 class="card-title">All System Users List</h3>
											</div>
															...
															<div class="row align-items-center">
																<div class="col-md-3 my-2 my-md-0">
																	<div class="input-icon">
																		<input type="text" name="q" data-url="{{ route('admin.searchAjax', ['type' => 'systemUser']) }}" class="form-control ajax-data-search" placeholder="Enter Name, mobile, email" id="kt_datatable_search_query" />
																		<span>
