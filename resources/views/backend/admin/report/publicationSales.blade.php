...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <!--begin::Subheader-->
    <div class="subheader py-2 py-lg-6 subheader-solid hideIt" id="kt_subheader">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                                ...
                                <div class="card-toolbar">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 pr-0">
                                            <select class="form-control form-control-lg form-control-solid ajax-data-search align-left" name="q" id="salesCenter" data-select="{{ route('admin.searchAjax', ['type' => 'publicationSalesCenterSelect']) }}" required>
                        ...
                        <div class="form-group card-body mb-0 pb-0 hideIt">
                        ...
                        <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0 showIt" style="display:none;">
                            <div class="col-md-12">
                                ...
                                <div class="d-flex justify-content-between pt-6">
                                    <span> <span style="font-weight: bold">Report Name:</span> Publication Sales </span>
                        ...
                        <div class="card-body">
                            <div class="table-responsive ajax-data-container">
                                @include('backend.admin.report.ajax.publicationSalesTable')
                            </div>
                            {{ $orders->links() }}
                        </div>
                        <div class="card-footer">
                            @if (Auth::user()->role_id != 11)
                                <button type="button" class="btn btn-primary font-weight-bold float-right hideIt"
                                    onclick="window.print()">Print</button>    
                            @else
                                <button type="button" class="btn btn-primary font-weight-bold float-right"
            ...
            <div class="row justify-content-center bg-gray-100 py-8 px-8 py-md-10 px-md-0">
                <div class="col-md-9">
                    <div class="table-responsive">
                        @include('backend.admin.report.ajax.publicationSalesTablePrint')
                    </div>
                </div>
            </div>
            <!-- end: Invoice footer-->
