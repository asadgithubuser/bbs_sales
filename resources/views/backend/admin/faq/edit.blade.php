            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom example example-compact">
                        ...
                        <form class="form" action="{{ route('admin.faq.update',$faq) }}" method="post" id="kt_form_1" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5 col-sm-12">
                                        <textarea type="text" class="form-control {{ $errors->has('question') ? ' is-invalid' : '' }}" name="question" placeholder="Enter Question" value="{{old('question')}}" required>{{$faq->question}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5 col-sm-12">
                                        <textarea type="text" class="form-control {{ $errors->has('answer') ? ' is-invalid' : '' }}" name="answer" placeholder="Enter Answer" value="{{old('answer')}}" required>{{$faq->answer}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5 col-sm-12">
                                        <input type="text" class="form-control {{ $errors->has('created_for') ? ' is-invalid' : '' }}" name="created_for" value="{{$faq->created_for}}">
                                    </div>
                                </div>
                            </div>
