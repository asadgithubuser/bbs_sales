                                                        ...
                                                        <div class="form-group col-sm-6">
                                                            <label class="col-form-label text-right font-weight-bold">ডেটা বিভাগ : </label>
                                                                ...
                                                                @if ($serviceItem->service_item_type == 1)
                                                                    <input class="form-control form-control-lg form-control-solid" value="Survey" disabled/>
                                                                @elseif ($serviceItem->service_item_type == 2)
                                                                    <input class="form-control form-control-lg form-control-solid" value="Census" disabled/>
                                                                @else
                                                                    <input class="form-control form-control-lg form-control-solid" value="Other" disabled/>
                                                                @endif
