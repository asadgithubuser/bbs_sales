            ...
            <tr>
                    ...
                    @else
                        ...
                        @elseif($serviceItem->service_item_type == 2){{-- Census --}}
                            @php
                                $priceData = App\Models\ServiceItemPrice::where('price_type', 2)->where('usage_type', 2)->orWhere('usage_type',3)->first();
                            @endphp
                        @elseif($serviceItem->service_item_type == 3){{-- Other --}}
                            @php
                                $priceData = App\Models\ServiceItemPrice::where('price_type', 5)->where('usage_type', 2)->orWhere('usage_type',3)->first();
                                
                            @endphp

                        @endif
                    
                        {{ number_format($priceData->price, 2)}} USD
                    @endif
                </td>
                ...
                <td>
                    ...
                    @else
                        ...
                        @elseif($serviceItem->service_item_type == 3){{-- Other --}}
                            @php
                                $priceData = App\Models\ServiceItemPrice::where('price_type', 5)->where('usage_type', 1)->first();
                            @endphp
                        @endif
                ...
                @elseif ($serviceItem->service_item_type == 3)
