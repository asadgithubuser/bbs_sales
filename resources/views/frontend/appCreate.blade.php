						...
						<div class="col-lg-12">
							...
							<div class="card card-custom example example-compact">
								<div class="card-header">
									<h3 class="card-title">Micro Data Application</h3>
									...
									<div class="card-body application-card">
										...
										<div class="card card-custom example example-compact">
											<div class="form-group m-0">
												<div class="alert alert-custom alert-default" role="alert">
													<div class="alert-text form_header"><span class="font-weight-bold">User Type and Country</span></div>
												</div>
											</div>
											...
											<div class="form-group row mt-2 usage-type">
											...
											<div id="personal" style="display: none">
												...
												<div class="form-group row">
													<label class="col-form-label text-right col-lg-3 col-sm-12">Address :<span class="text-danger">*</span></label>
													<div class="col-lg-8 col-md-8 col-sm-12">
														<input type="text" class="form-control personal_address" name="personal_address" placeholder="Enter Address" value=""/>
										...
										<div class="card card-custom example example-compact" id="user_location" style="display: none">
											...
											<div class="form-group row">
												...
												<label class="col-form-label text-right col-lg-3 col-sm-12 pl-0 pr-0">Select Division :<span class="text-danger">*</span></label>
											...
											<div class="form-group row">
												...
												<label class="col-form-label text-right col-lg-3 col-sm-12 pl-0 pr-0">Select Upazila :<span class="text-danger">*</span></label>
												<div class="col-lg-3 col-md-4 col-sm-12">
											...
											<div class="form-group row">
												...
												<label class="col-form-label text-right col-lg-3 col-sm-12 pl-0 pr-0">Select Mouza :<span class="text-danger">*</span></label>
												<div class="col-lg-3 col-md-4 col-sm-12">
												...
												<div class="col-lg-8 col-md-8 col-sm-12">
													<div class="radio-inline" id="receiving_mode2">
														...
														@foreach ($receivingModes as $receivingMode)
															<label class="col-form-label radio"> 
																<input type="radio" name="receiving_mode_softcopy" id="receiving_mode_softcopy" class="dataChange" value="{{ $receivingMode->id }}" >
