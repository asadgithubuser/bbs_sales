										...
										<table class="table table-bordered"> 
											<thead>
												<tr id="selectedServices"> 
													...
													<th style="padding: 0;border-bottom:none;" colspan="2">
														<div class="form-group" style="margin-bottom: 0">
															<div class="alert alert-custom alert-default" role="alert">
													...
													<td colspan="2">
														<div class="alert-text text-right">
															<span class="font-weight-bold">
																...
																{{-- <span type="text" class="totalPrice" value="" readonly style="border: none; font-weight:bold;width: 100%; text-align: right;"></span> <span style="font-weight:bold;width: 100%; text-align: right;" id="inv_currency_label"></span> --}}
															</span>
