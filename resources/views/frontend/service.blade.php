                    ...
                    @foreach ($serviceItems as $item)
                        <div class="card mb-2" style="box-shadow: 0px 0px 3px 0px;">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-2">Item Price: {{$item->price < 1 ? "Free" : $item->price}}</h6>
                                ...
                                <div class="modal-content" style="height: 80vh;">
                                    ...
                                    <div class="modal-body" style="padding: 20px 80px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h2><a href="{{ route('application.create') }}" class="app_purchase_btn">Purchase The Service</a></h2>
                                            </div>
                                        </div>
