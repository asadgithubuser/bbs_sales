...
class CropCuttingProductionFormController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->cluster_name){
            $clusterDetails = Cluster::where('id',$request->cluster_name)->first();
        }
        ...
        $cropCuttingProductionForm->cluster_id                      = $request->cluster_name;
        ...
        $cropCuttingProductionForm->cluster_area_acre               = $clusterDetails->cluster_area;
        ...
        if($request->other_fertilizers)
        {

            $cropCuttingProductionForm->other_fertilizers               = $request->other_fertilizers;
        }
