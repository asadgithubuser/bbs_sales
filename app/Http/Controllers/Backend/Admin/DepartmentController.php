...
class DepartmentController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Gate::allows('manage_department', $user)) 
        {
            ...
            {            
                menuSubmenu('department', 'all_departments');

                $departments = Department::with('level')->latest()->paginate(25);
    ...
    public function create()
    {
        ...
        if (Gate::allows('manage_department', $user)) 
        {
            ...
            {            
                ...
                return view('backend.admin.department.create', compact('levels'));
    ...
    public function show($id)
    {
        ...
        if (Gate::allows('manage_department', $user)) 
        {
            ...
            {            
                $department = Department::with('level', 'user', 'user_update')
                                ->where('id', $id)
                                ->first();
    ...
    public function edit($id)
    {
        ...
        if (Gate::allows('manage_department', $user)) 
        {
            ...
            {            
                ...
                $department = Department::with('level')->where('id', $id)->first();

                return view('backend.admin.department.edit', compact('department', 'levels'));
