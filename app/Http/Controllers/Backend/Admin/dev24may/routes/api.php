...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    ...
    Route::prefix('seller')->group(function () {
        Route::get('orders', 'Api\V2\SellerController@getOrderList')->middleware('auth:sanctum');;
        Route::get('orders/details/{id}', 'Api\V2\SellerController@getOrderDetails')->middleware('auth:sanctum');
        Route::get('orders/items/{id}', 'Api\V2\SellerController@getOrderItems')->middleware('auth:sanctum');  
    });
    ...
    Route::get('chat/conversations', 'Api\V2\ChatController@conversations')->middleware('auth:sanctum');
	...
	//
    Route::get('products/top-from-seller/{id}', 'Api\V2\ProductController@topFromSeller');
    ...
    Route::get('cart-counts', 'Api\V2\CartController@cart_count')->middleware('auth:sanctum');
	...
	//added
    Route::post('reviews/upload-image', 'Api\V2\ReviewController@uploadImage')->middleware('auth:sanctum');
	...
	Route::get('sliders', 'Api\V2\SliderController@index')->name('index');
