...
Route::any('/store_export', 'AizUploadController@store_export')->name('store_export');
...
Route::any('/home/section/todays-deal', 'HomeController@load_todays_deal_section')->name('home.section.todays_deal');
Route::post('/home/section/new-products', 'HomeController@load_new_products_section')->name('home.section.new_products');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::get('/customer_review', 'HomeController@customer_review')->name('customer_review');
...
//products listing by features
Route::get('/products/{feature}', 'ProductController@productsByFearture')->name('products.products_by_feature');


//get all best sellers
Route::get('/best-sellers', 'SellerController@getAllBestSellers')->name('all.best.sellers');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/products/new', 'ProductController@updateNewProduct')->name('products.update_new_product');
    Route::post('/products/top-product', 'ProductController@updateTopProduct')->name('products.update_top_product');
    ...
    //Product Export
    Route::get('/product-bulk-export/{id}', 'ProductBulkUploadController@export')->name('product_bulk_export.index');
...
//Pack Model
Route::post('/pactrack', 'HomeController@pacTrack')->name('pac.track');