...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::post('/bulk-seller-email-validate', 'SellerController@bulk_seller_email_validate')->name('bulk-seller-email-validate');
    ...
    Route::get('/user_activity', 'StaffactivityController@user_activity')->name('user_activity.index');
    Route::get('/user_activity/destroy/{id}', 'StaffactivityController@destroy')->name('user_activity.destroy');


    Route::resource('flash_deals', 'FlashDealController');
	
	//new 
	Route::post('/flash_deals/load-products', 'FlashDealController@productsLoadByCat')->name('flash_deals.products_load_by_category');
    Route::post('/flash_deals/delete', 'FlashDealController@flashDealItemDelete')->name('delete.flash-discount-deal-item');
	...
	//added
	Route::post('/flash_deals/get_products_by_category', 'FlashDealController@get_products_by_category')->name('flash_deals.get_products_by_category');
    ...
    // this route for export all orders as CSV
    Route::any('/all-orders', 'OrderController@allOrdersExport')->name('order.export.default');
    // order export all from Sales/order export menu
    Route::get('/bulk-orders-export', 'OrderController@defaultOrdersExport')->name('bulk_order_export.index');



    //Shipping Category
    Route::POST('/shippingcat/update', 'ShippingController@shipping_category_update')->name('shippingcat.update');
    Route::get('/shippingcat', 'ShippingController@shippingcat')->name('cities.shippingcat');

    Route::get('/shipping/{parents}', 'ShippingController@citylist');
    Route::get('/shipping_configuration', 'BusinessSettingsController@shipping_configuration')->name('shipping_configuration.index');
    Route::post('/shipping_configuration/update', 'BusinessSettingsController@shipping_configuration_update')->name('shipping_configuration.update');
    Route::post('/ShippingController/update/CostIncrement', 'ShippingController@updateCostIncrement')->name('ShippingController.update.CostIncrement');
    

    //shipping area operation
    Route::get('/cost-configuration', 'ShippingConfigureController@index')->name('cost.index'); 
    Route::post('/cost-configuration', 'ShippingConfigureController@costAssignToProducts')->name('cost.assign');



    Route::get('/notification', 'NotificationController@main')->name('notification.main');
    Route::post('/notification/store_promos', 'NotificationController@store_promos')->name('notification.store_promos');
    Route::get('/notification/edit/{id}', 'NotificationController@edit_promos')->name('notification.edit_promos');
    Route::get('/notification/filter', 'NotificationController@filter')->name('notification.filter');
