...
class DigitalProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Start to get linked product
        $product->isLinked = ($request->isLinked == 1)? $request->isLinked: 0;
        $product->product_link = $request->product_link; 
        // End to get linked product
    ...
    public function update(Request $request, $id)
    {
        ...
        $product->isLinked = $request->isLinked;
        if($request->isLinked == 1){
        $product->product_link = $request->product_link;
        }else{
