...
class ZoneController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.setup_configurations.zones.create', compact('cities'));
    }
    ...
    {   
        ...
        $cities = City::where('zone_id', null)->where('status', 1)->orWhere(function($query) use ($zone){
            return $query->where('zone_id', $zone->id);
        })->get();
        return view('backend.setup_configurations.zones.edit', compact('zone', 'cities'));
    }
