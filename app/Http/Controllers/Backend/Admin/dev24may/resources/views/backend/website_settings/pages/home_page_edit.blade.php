							...
							@if (get_setting('home_slider_images') != null)
								@foreach (json_decode(get_setting('home_slider_images'), true) as $key => $value)
									<div class="row gutters-5">
										...
										<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_slider_order">
												<input type="number" Title="" placeholder="Order Number" class="form-control"   name="home_slider_order[]" value="{{ json_decode(get_setting('home_slider_order'), true)[$key] }}">
						...
						<button
							...
							<div class="row gutters-5">
								...
								<div class="col-md">
											<div class="form-group">
												<input type="hidden" name="types[]" value="home_slider_order">
												<input type="number" Title="" placeholder="Order Number" class="form-control"   name="home_slider_order[]" value="">
												<small>Higher number has high priority</small>
											</div>
								</div>
								<div class="col-md-auto">
