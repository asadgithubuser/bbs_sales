    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('store-campaign-category') }}" method="POST">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-3 control-label" for="name">{{translate('Category Name')}}</label>
                            <div class="col-sm-9">
                                <input type="text" placeholder="{{translate('Category Name')}}" id="name" name="name" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <span class="small text-muted">{{ translate('This image is shown as cover banner in flash deal category details page.') }}</span>
                            </div>
                        </div>
