                                ...
                                <div class="row">
                                    ...
                                    <div class="row costcat">
                                        ...
                                        <div class="col-4 boxh">
											...
											@php
												$parent_categories=app('App\Http\Controllers\ShippingController')->shippingCategoriesAll();
												$shipping_cost_area=app('App\Http\Controllers\BusinessSettingsController')->BusinessSettings('shipping_cost_area'); 
											@endphp
                                                <ul id="myUL">
                                                    @php $sl=1; @endphp
                                                    @foreach ($parent_categories  as $shipcat)
														@if($shipcat->parent_id =='')
												...
												@if($shipcat->parent_id =='')
                                                    <div class="tab-pane fade" id="list-home{{ $shipcat->id }}" role="tabpanel" aria-labelledby="ist-home-list{{ $shipcat->id }}">
                                                        ...
                                                        <table class="shipcat" border="1" width="100%">
                                                            ...
                                                            <tbody>
                                                            @php $sl=1; @endphp
                                                            @foreach ($parent_categories as $shippingSubCategoriesSingle)
															@if($shippingSubCategoriesSingle->parent_id ==$shipcat->id)
