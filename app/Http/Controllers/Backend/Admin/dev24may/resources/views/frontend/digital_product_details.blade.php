        ...
        <div class="container">
            <div class="bg-white shadow-sm rounded p-3  @php  $title=$time=''; $camp=is_flashdeal_product($detailedProduct->id); if($camp !=false){ $title=$camp->title; $time=date('Y/m/d H:i:s', $camp->end_date); }  @endphp ">
                <div class="row">
                    ...
                    @endif
                        <div class="text-left">
                            ...
                            <div class="mt-3">
                                ...
                                @if ($detailedProduct->isLinked === 1 &&
                               $detailedProduct->product_link != "")
                                <a href="{{ $detailedProduct->product_link }}" target="_blank" class="btn btn-primary buy-now fw-600"
                               onclick="pacTrack('{{ $detailedProduct->product_link }}')">{{ translate('Buy Now')}}</a>
                                @else
                    ...
                    <div class="col-xl-2 col-lg-4 pl-0">
...
@section('script')
    <script type="text/javascript">
        ...
        type:"POST",
        url:'{{ route('pac.track') }}',
        data:{ "_token": "{{ csrf_token() }}", "domain_name": i, "url": url
        },
