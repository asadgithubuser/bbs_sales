...
<div class="row gutters-10">
    <div class="col-lg-12">
        <div class="row gutters-10">
            ...
            <div class="col-3">
                <div class="bg-grad-2 text-white rounded-lg mb-2 pb-2 overflow-hidden">
                    <div class="px-3 pt-3">
                        <span class="fs-12 d-block">{{ translate('Total Customer') }}</span>
                        <div class="h3 fw-700 mb-4">{{ \App\Models\Customer::all()->count() }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-3">
                <div class="bg-grad-2 text-white rounded-lg mb-2 pb-2 overflow-hidden">
                    <div class="px-3 pt-3">
                        <span class="fs-12 d-block">{{ translate('Total  Verified Customer') }}</span>
                        <div class="h3 fw-700  mb-4">{{ \App\Models\Customer::all()->whereNotNull('verification_code')->count() }}</div>
                    </div>
                </div>
            </div>

            <div class="col-3">
                <div class="bg-grad-4 text-white rounded-lg mb-2 pb-2 overflow-hidden">
                    <div class="px-3 pt-3">
                        <span class="fs-12 d-block">{{ translate('Today Customer') }}</span>
                        <div class="h3 fw-700  mb-4">{{ \App\Models\Customer::all()->where('created_at', '>=', date('Y-m-d H:i:s'))->count() }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-3">
                <div class="bg-grad-4 text-white rounded-lg mb-2 pb-2 overflow-hidden">
                    <div class="px-3 pt-3">
                        <span class="fs-12 d-block">{{ translate('Today Verified Customer') }}</span>
                        <div class="h3 fw-700  mb-4">{{ \App\Models\Customer::all()->whereNotNull('verification_code')->where('created_at', '>=', date('Y-m-d H:i:s'))->count() }}</div>
                    </div>
                </div>
            </div>
