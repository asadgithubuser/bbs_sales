...
@if($coupon->role == 0)
<div class="form-group row">
    <label class="col-sm-3 control-label" for="start_date">{{translate('Only for App')}}</label>
    <div class="col-sm-2 text-center">
        <input class="form-check-input" style="width: 1rem;height: 1rem;" type="checkbox" name="role">
    </div>
</div>
@else
<div class="form-group row">
    <label class="col-sm-3 control-label" for="start_date">{{translate('Only for App')}}</label>
    <div class="col-sm-2 text-center">
        <input class="form-check-input" style="width: 1rem;height: 1rem;" checked type="checkbox" name="role">
    </div>
</div>
@endif
