        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('zones.update', $zone) }}" method="POST"
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">
                            {{ translate('Additional Cost Per Kg') }}
                        </label>
                        <div class="col-md-9">
                            <input type="number" step="0.01" name="express_delivery_cost" class="form-control" id="express_delivery_cost" value="{{ $zone->express_delivery_cost }}" placeholder="{{ translate('Additional Cost Per Kg') }}" required>
                        </div>
                    </div>
