...
<div class="position-relative top-banner removable-session z-1035 d-none" data-key="top-banner" data-value="removed">
    <a href="{{ get_setting('topbar_banner_link') }}" class="d-block text-reset">
        <img src="{{ uploaded_asset(get_setting('topbar_banner')) }}" class="w-100 mw-100 d-none d-lg-block h-lg-auto img-fit">
    </a>
...
<div class="top-navbar bg-white border-bottom border-soft-secondary z-1035">
    <div class="container">
        <div class="row float-right">
            <div class="">
                <ul class="list-inline justify-content-between float-right justify-content-lg-start mb-0 pr-3">
                    @if(get_setting('show_language_switcher') == 'on')
                    <li class="float-right list-inline-item dropdown" id="lang-change">
                        @php
            ...
            <div class="text-left d-none d-lg-block">
                <ul class="list-inline mb-0 h-100 border-left  float-right justify-content-end align-items-center">
                    @if (get_setting('helpline_number'))
                        <li class="list-inline-item top-bar border-right border-left-0">
                    ...
                    @auth
                        @if(isAdmin())
                            <li class="list-inline-item top-bar border-right border-left-0 pl-0">
                                <a href="{{ route('admin.dashboard') }}" class="text-reset d-inline-block opacity-60 py-2">{{ translate('My Panel')}}</a>
                            </li>
                        @else

                            <li class="list-inline-item border-right border-left-0 top-bar dropdown">
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
        ...
        <div class="container">
            <div class="d-flex align-items-center">
                <div class="col-auto col-xl-3 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-0px mr-3 ml-0" href="{{ route('home') }}">
                        @php
                            $header_logo = get_setting('header_logo');
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-50px h-md-80px" height="80">
                        @else
                            <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-50px h-md-80px" height="80">
                        @endif
                    </a>
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div class="main_home_menu bg-white border-top border-gray-200 py-1">
            <div class="container">
                <div class="row">
                    <div class="col-md-2 offset-md-1">
                        {{--@if(Route::currentRouteName() == 'home')--}}
                            <div class="d-none d-xl-block align-self-stretch category-menu-icon-box ml-auto mr-0" id="category-menu-icon">
                                <div class="h-100 d-flex align-items-center" >
                                    <div class="dropdown-toggle dropdown-toggle-home opacity-60 navbar-light text-white h-40px w-150px pl-2 rounded c-pointer hov-opacity-100">
                                        {{-- <span class="navbar-toggler-icon"></span> --}}
                                        <a href="{{ route('categories.all') }}" class="text-reset">
                                            <strong>{{ translate("Shop By Category") }}</strong>
                                        </a>
                                    </div>

                                    <div class="hover-category-menu hover-category-home position-absolute w-100 top-100 left-0 right-0 d-none z-3" id="hover-category-menu">
                    ...
                    <div class="col-md-9">
                        <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center">
                            ...
                            <li class="text-white list-inline-item mr-0">
