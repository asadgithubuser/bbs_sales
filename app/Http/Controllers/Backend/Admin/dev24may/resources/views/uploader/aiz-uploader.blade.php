	...
	<div class="modal-dialog modal-adaptive" role="document">
		<div class="modal-content h-100">
			<div class="modal-header pb-0 bg-light">
				...
				<button data-toggle="aizuploader" id="aizuploader_refresh" style="border: 0;">Refresh</button>
 
 			
				
<select  onchange="change_defaultFormat('save_to')"  name="cars" class="ml-2" id="save_to">
  <option value="jpeg">save to JPEG</option>
  <option value="png">save to PNG</option>
</select>
							 
				
				
<span class="ml-3">Image Quality: <input type="text" style="width:40px" onkeyup="change_defaultValue('export_value')"  id="export_value" value="90"> % </span>
