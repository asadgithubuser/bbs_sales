            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    ...
                    <div class="text-center py-4 mb-4">
                        ...
                        <!------updated this line for user phone------->
                        <p class="opacity-70 font-italic">{{  translate('A copy of your order summary has been sent to') }} {{ json_decode($first_order->shipping_address)->email }} {{ json_decode($first_order->shipping_address)->phone }}</p>
                        <!---------end update------->
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <table class="table">
                                    ...
                                    <!----adding this extra row for to show shipping phone number----->
                                    <tr>
                                        <td class="w-50 fw-600">{{ translate('Phone')}}:</td>
                                        <td>{{ json_decode($first_order->shipping_address)->phone }}</td>
                                    </tr>
                                    <!----end update---->
                                    <tr>
