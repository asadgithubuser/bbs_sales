                                ...
                                <tr>
                                    ...
                                    @if (addon_is_activated('refund_request'))
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('product', $orderDetail->product->slug) }}"  target="_blank" class="text-primary v-btn v-btn--text theme--light v-size--small"><span class="v-btn__content">Write a review</span></a>
                                            @else
