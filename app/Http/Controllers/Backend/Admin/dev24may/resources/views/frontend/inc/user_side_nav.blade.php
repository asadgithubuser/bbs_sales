            ...
            <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                ...
                @else
                    ...
                    @endif
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customer_review') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customer_review'])}}">
                                <i class="las la-star-half-alt aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">{{ translate('Product Review') }}</span>
                            </a>
                        </li>
                    ...
                    @if(Auth::user()->user_type == 'seller')
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('reviews.seller') }}" class="aiz-side-nav-link {{ areActiveRoutes(['reviews.seller'])}}">
                                <i class="las la-star-half-alt aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">{{ translate('Seller Product Reviews') }}</span>
                            </a>
                        </li>
