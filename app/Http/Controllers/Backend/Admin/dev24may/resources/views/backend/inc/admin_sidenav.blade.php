        ...
        <div class="aiz-side-nav-wrap">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('coupon.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['coupon.index','coupon.create','coupon.edit'])}}">
							        ...
							        <li class="aiz-side-nav-item">
                                        <a href="{{route('notification.main')}}" class="aiz-side-nav-link {{ areActiveRoutes(['notification.main','notification.edit_promos','notification.filter'])}}">
            ...
            <!-- Setup & Configurations -->
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                           ...
                           <li class="aiz-side-nav-item">
                                <a href="javascript:void(0);" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text"><i class="las la-shopping-cart aiz-side-nav-icon"></i> {{translate('Shipping')}}</span>
                                    <span class="aiz-side-nav-arrow"></span>
                                </a>
                                <ul class="aiz-side-nav-list level-3">
                                    <li class="aiz-side-nav-item">
                                    ...
                                    <li class="aiz-side-nav-item">
                                        <a href="{{url('/admin/shippingcat')}}" class="aiz-side-nav-link  {{ (request()->is('admin/shippingcat*')) ? 'active' : '' }}">
                                        <span class="aiz-side-nav-text">{{translate('Shipping Cost Categories')}}</span>
                                        </a>
                                     </li>
                                    <li class="aiz-side-nav-item">
									...
									<li class="aiz-side-nav-item">
                                        <a href="{{ route('cost.index') }}"
                                            ...
                                            <span class="aiz-side-nav-text">{{ translate('Cost Configuration') }}</span>
                                        </a>
                                    </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('20', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('user_activity.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['roles.index', 'roles.create', 'roles.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Staff Activity')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
